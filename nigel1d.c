...
bool func_264(var uParam0, struct<2> Param1, float fParam3)//Position - 0x298BD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_279(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2A045
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_283(struct<3> Param0, struct<3> Param3)//Position - 0x2A311
{
...
int func_292(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2A6D6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
bool func_315(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2C83D
{
...
float func_320(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2CA8E
{
	struct<3> Var0;
...
void func_337(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D821
{
	func_338(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_338(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D83F
{
...
void func_339(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D877
{
	int iVar0;
	int iVar1;
...
void func_355(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2E277
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_358(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2E3BA
{
	if (bParam6)
	{
...
int func_428(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x34526
{
	int iVar0;
	int iVar1;
...
int func_435(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x35140
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_440(struct<3> Param0, float fParam3)//Position - 0x35A9E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_471(struct<3> Param0, bool bParam3)//Position - 0x37668
{
	int iVar0;
...
void func_485(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x37EAA
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_505(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x38B1F
{
	int iVar0;
...
void func_509(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x38D8E
{
	if (func_541())
	{
...
int func_512(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x38E5D
{
	bool bVar0;
	float fVar1;
