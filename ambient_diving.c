...
void func_37(var uParam0, var uParam1, bool bParam2)//Position - 0x1864
{
	int iVar0;
...
void func_43(var uParam0, bool bParam1)//Position - 0x1AD9
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_44(int iParam0, bool bParam1, bool bParam2)//Position - 0x1B4B
{
...
void func_45(int* iParam0, bool bParam1, bool bParam2)//Position - 0x1C37
{
	if (bParam1 < 0 || bParam1 >= 64)
	{
		return;
