...
int func_145(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xA968
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_146(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xAD02
{
	if (bParam6)
	{
