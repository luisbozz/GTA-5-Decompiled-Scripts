...
int func_13(bool bParam0)//Position - 0x10E2
{
	var uVar0;
...
int func_102(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)//Position - 0x47F2
{
...
int func_103(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x4904
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_113(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)//Position - 0x4C7D
{
	int iVar0;
	int iVar1;
...
void func_209(struct<3> Param0, var uParam3)//Position - 0x8556
{
	int iVar0;
	int iVar1;
...
int func_210(struct<3> Param0, int iParam3, float fParam4)//Position - 0x869A
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
...
Vector3 func_228(var* uParam0, int iParam1, struct<3> Param2, bool bParam5)//Position - 0xC757
{
...
int func_303(struct<2> Param0, var uParam2, var uParam3, var uParam4)//Position - 0xF930
{
	int iVar0;
...
int func_326(struct<17> Param0, var uParam17, var uParam18, var uParam19, var uParam20, bool bParam21)//Position - 0x10819
{
	char cVar0[32];
	bool bVar8;
	int iVar9;
...
int func_359(struct<3> Param0, struct<3> Param3)//Position - 0x11F00
{
	struct<3> Var0;
...
void func_410(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x12C9E
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_409();
