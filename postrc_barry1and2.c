...
int func_13(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x612
{
	int iVar0;
...
void func_20(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x968
{
	func_21(iParam0);
