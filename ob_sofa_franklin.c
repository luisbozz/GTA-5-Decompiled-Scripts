...
int func_90(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x4744
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_91(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x47F7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
