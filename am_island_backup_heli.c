...
int func_36(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xD2D
{
	float fVar0;
	int iVar1;
...
void func_37(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xE36
{
	int iVar0;
...
int func_38(int iParam0, struct<3> Param1, int iParam4)//Position - 0xF09
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_41(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)//Position - 0x10B8
{
...
int func_42(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x11CA
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_50(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)//Position - 0x1506
{
	int iVar0;
	int iVar1;
...
Vector3 func_57(struct<3> Param0, float fParam3, struct<2> Param4, float fParam6)//Position - 0x172C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_100(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x2724
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_85();
