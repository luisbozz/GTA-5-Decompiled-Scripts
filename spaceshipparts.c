...
void func_28(var uParam0, var uParam1, bool bParam2)//Position - 0xE73
{
	int iVar0;
...
void func_37(var uParam0, bool bParam1)//Position - 0x11A2
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_38(int iParam0, bool bParam1, bool bParam2)//Position - 0x1214
{
...
void func_39(int* iParam0, bool bParam1, bool bParam2)//Position - 0x1300
{
	if (bParam1 < 0 || bParam1 >= 64)
	{
		return;
