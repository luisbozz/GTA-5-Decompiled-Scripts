...
int func_48(struct<6> Param0, struct<6> Param6)//Position - 0x2392
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_89(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14)//Position - 0x3005
{
...
void func_95(bool bParam0)//Position - 0x317C
{
...
int func_174(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x4D47
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_213(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x5B62
{
