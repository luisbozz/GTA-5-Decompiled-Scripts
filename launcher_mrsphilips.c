...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5BC5
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6388
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6831
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x718F
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_190(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xC9E3
{
	struct<3> Var0;
...
int func_210(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDB51
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_214(struct<3> Param0, struct<3> Param3)//Position - 0xDE1D
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_222(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE19B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_245(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE988
{
	int iVar0;
...
int func_246(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xE9ED
{
	int iVar0;
	struct<7> Var1;
...
int func_247(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xEA65
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
