...
void func_67(int iParam0, bool bParam1, bool bParam2)//Position - 0x662C
{
	if (iParam0 == -1)
	{
		return;
...
int func_77(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x838F
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_78(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x8597
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_94(var uParam0, int iParam1, int iParam2)//Position - 0x9729
{
...
void func_109(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x9A9B
{
	int iVar0;
...
bool func_111(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9B20
{
	if (bParam6)
	{
...
int func_116(struct<3> Param0, int iParam3)//Position - 0x9C0A
{
	return func_117(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_117(int iParam0, struct<3> Param1, int iParam4)//Position - 0x9C27
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_132(struct<3> Param0, bool bParam3)//Position - 0xAF81
{
	int iVar0;
...
void func_160(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xC0A8
{
	struct<3> Var0;
	var uVar3;
...
void func_161(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0xC123
{
	struct<60> Var0;
...
void func_174(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xC64C
{
	if (func_73(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_177(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xC7E3
{
	int iVar0;
...
int func_178(struct<3> Param0, int iParam3, int iParam4)//Position - 0xC8F9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_184(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xCBB7
{
	if (func_30())
	{
