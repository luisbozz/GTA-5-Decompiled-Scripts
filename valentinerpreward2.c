...
Vector3 func_5(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x4AD
{
	return FtoV((1f - fParam6)) * Param0 + Vector(fParam6, fParam6, fParam6) * Param3;
}

Vector3 func_6()//Position - 0x4C8
{
	switch (iLocal_19)
	{
		case 0:
...
int func_8()//Position - 0x578
{
	return 3150;
}

int func_9(var uParam0, bool bParam1, bool bParam2)//Position - 0x583
{
...
void func_10(var uParam0, bool bParam1, bool bParam2)//Position - 0x5CA
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
void func_12(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x640
{
	int iVar0;
...
int func_13(var uParam0)//Position - 0x670
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0, int iParam1, int iParam2)//Position - 0x6B0
{
	int iVar0;
	var uVar1;
...
bool func_19(int iParam0, struct<3> Param1, float fParam4)//Position - 0x80F
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, true), Param1) <= (fParam4 * fParam4);
}

bool func_20(int iParam0, int iParam1)//Position - 0x82C
{
	if (iParam1 == -1)
	{
		iParam1 = func_14();
...
void func_21(var uParam0)//Position - 0x848
{
	uParam0->f_1 = 0;
}

void func_22(var uParam0, bool bParam1, bool bParam2)//Position - 0x855
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
	{
		if (!bParam2)
...
int func_23(var uParam0, int iParam1, bool bParam2)//Position - 0x892
{
	if (iParam1 == -1)
	{
		return 1;
...
bool func_24(var uParam0)//Position - 0x8F0
{
	return uParam0->f_1;
}

void func_25()//Position - 0x8FC
{
	bool bVar0;
...
int func_26()//Position - 0xA2C
{
	return Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_192;
}

int func_27(int iParam0)//Position - 0xA41
{
...
int func_28(int iParam0, bool bParam1, bool bParam2)//Position - 0xA72
{
	int iVar0;
...
int func_29()//Position - 0xAD2
{
	return -1;
}

int func_30(int iParam0)//Position - 0xADB
{
	if (iParam0 != func_29())
	{
...
int func_32()//Position - 0xB56
{
	return Global_1574632.f_18;
}

bool func_33()//Position - 0xB64
{
	return Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_192 != 0;
}

void func_34(bool bParam0)//Position - 0xB7B
{
	func_35(bParam0);
	if (bParam0)
	{
...
void func_35(bool bParam0)//Position - 0xBC1
{
	if (bParam0)
	{
...
int func_36(int iParam0)//Position - 0xBE7
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_38(int iParam0, int iParam1)//Position - 0xCF9
{
	struct<45> Var0;
...
void func_39(int iParam0, var uParam1, int iParam2)//Position - 0xEEA
{
	int iVar0;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0xF27
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
int func_41(int iParam0, var uParam1, int iParam2, bool bParam3)//Position - 0xF4C
{
	if (iParam2 == -1)
	{
		return 1;
...
char* func_44(bool bParam0)//Position - 0x1006
{
	switch (bParam0)
	{
		case 0:
...
int func_46(int iParam0)//Position - 0x11E2
{
...
int func_49(int iParam0)//Position - 0x12C0
{
	if (iParam0 != func_29())
	{
		if (func_28(iParam0, 1, 1))
...
int func_50(int iParam0)//Position - 0x1307
{
	switch (iParam0)
	{
		case 0:
...
int func_52(int iParam0)//Position - 0x1882
{
...
int func_53(int iParam0)//Position - 0x18BB
{
	if (iParam0 != func_29() && func_28(iParam0, 1, 1))
	{
...
int func_54(int iParam0)//Position - 0x18EC
{
...
int func_56(int iParam0)//Position - 0x195A
{
...
int func_57(int iParam0)//Position - 0x197C
{
	switch (iParam0)
	{
		case 87:
...
int func_58(int iParam0, bool bParam1, int iParam2)//Position - 0x19AB
{
	int iVar0;
...
int func_59(int iParam0, int iParam1)//Position - 0x1A07
{
	if (iParam0 != func_29())
	{
...
int func_61(int iParam0)//Position - 0x1AE5
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
float func_62(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1B9E
{
	struct<3> Var0;
...
int func_63(int iParam0, bool bParam1)//Position - 0x1BD8
{
	if (Global_78319)
	{
...
void func_64(int iParam0, var uParam1)//Position - 0x1C17
{
	int iVar0;
	var uVar1;
...
int func_65(struct<3> Param0)//Position - 0x1D11
{
...
int func_66(int iParam0)//Position - 0x1D3B
{
	if (iParam0 != func_29())
	{
...
bool func_68()//Position - 0x1E84
{
	return Global_1946250.f_4711.f_1 != -1;
}

bool func_69()//Position - 0x1E97
{
	return Global_1946250.f_4716 != -1;
}

void func_70(int iParam0)//Position - 0x1EA8
{
	if (func_71() && iParam0)
	{
		return;
...
bool func_73()//Position - 0x1F6D
{
	return MISC::GET_GAME_TIMER() <= Global_23150.f_6269 + 100;
}

Vector3 func_74(int iParam0, int iParam1)//Position - 0x1F82
{
	switch (iParam0)
	{
		case 0:
...
float func_75(int iParam0, int iParam1)//Position - 0x1FEE
{
	if (iParam1 == 0)
	{
		switch (iParam0)
...
Vector3 func_76(int iParam0, int iParam1)//Position - 0x204B
{
	if (iParam1 == 0)
	{
		switch (iParam0)
...
int func_77(int iParam0)//Position - 0x20F0
{
	if (iParam0 != func_29())
	{
		if (func_28(iParam0, 1, 1))
...
int func_78(int iParam0)//Position - 0x215F
{
	if (iParam0 != func_29())
	{
		if (func_28(iParam0, 1, 1))
...
int func_82()//Position - 0x2B6B
{
	return Global_262145.f_26763;
}

void func_83()//Position - 0x2B7A
{
...
int func_85(int iParam0)//Position - 0x2BE5
{
	int iVar0;
	var uVar1;
...
void func_92(float fParam0, float fParam1, char* sParam2, char* sParam3)//Position - 0x2FBD
{
