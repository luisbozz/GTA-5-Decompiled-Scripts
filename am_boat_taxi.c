...
void func_5(bool bParam0, int iParam1)//Position - 0x3CA
{
...
void func_16(struct<67> Param0, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, int iParam85)//Position - 0x12A0
{
	struct<3> Var0;
	int iVar36;
...
var func_18(bool bParam0)//Position - 0x1340
{
	var uVar0;
...
int func_42(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2774
{
	float fVar0;
	int iVar1;
...
void func_43(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x287D
{
	int iVar0;
...
int func_44(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2950
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
int func_45(struct<3> Param0, float fParam3, float fParam4, float fParam5, float fParam6, int iParam7, bool bParam8, int iParam9, float fParam10, bool bParam11, int iParam12, bool bParam13, float fParam14, bool bParam15, float fParam16, bool bParam17, bool bParam18)//Position - 0x29EE
{
...
int func_46(struct<3> Param0, float fParam3, int iParam4, int iParam5, float fParam6, bool bParam7, int iParam8, float fParam9, bool bParam10)//Position - 0x2B00
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_54(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)//Position - 0x2E0D
{
	int iVar0;
	int iVar1;
...
Vector3 func_62(struct<3> Param0, float fParam3, float fParam4, float fParam5)//Position - 0x3074
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_63(struct<3> Param0, float fParam3)//Position - 0x30BD
{
	float fVar0;
...
void func_102(struct<2> Param0, Vector3 vParam2, struct<2> Param3, var uParam5)//Position - 0x44C1
{
...
void func_154(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x5CE0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_146();
