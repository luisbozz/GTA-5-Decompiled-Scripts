...
bool func_4(struct<3> Param0, var* uParam3, float fParam4, bool bParam5)//Position - 0x6A7
{
	var uVar0;
	struct<3> Var1;
...
void func_10(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7A7
{
	int iVar0;
	int iVar1;
...
void func_19(int iParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x9F1
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_20(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0xA50
{
	bool bVar0;
	float fVar1;
...
int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x139A
{
...
int func_57(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x146D
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
bool func_59(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x157C
{
...
bool func_112(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E19
{
...
void func_132(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3BA3
{
	struct<3> Var0;
	var uVar3;
...
void func_133(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3C1E
{
	struct<60> Var0;
...
void func_169(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x993A
{
	if (func_166(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_171(int iParam0, bool bParam1, bool bParam2)//Position - 0x9A90
{
	if (iParam0 == -1)
	{
		return;
...
bool func_176(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9C91
{
	if (bParam6)
	{
...
int func_183(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xA31D
{
	int iVar0;
...
int func_184(struct<3> Param0, int iParam3, int iParam4)//Position - 0xA433
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_187(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xA4F3
{
	func_188(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_188(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xA51C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_190(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xA93C
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_191(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xAC32
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_194(struct<3> Param0, int iParam3)//Position - 0xAD8A
{
	return func_195(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_195(int iParam0, struct<3> Param1, int iParam4)//Position - 0xADA7
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_199(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xAE76
{
	int iVar0;
...
int func_250(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x14675
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_326(int iParam0, struct<3> Param1, int iParam4, float fParam5)//Position - 0x297D6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_330(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x29AA3
{
	int iVar0;
...
int func_331(int iParam0, struct<3> Param1, float fParam4, float fParam5)//Position - 0x29C1B
{
...
void func_335(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x29CEA
{
...
void func_336(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x29D22
{
	int iVar0;
	int iVar1;
...
void func_351(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2A6C1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_379(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2C97A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_383(struct<3> Param0, struct<3> Param3)//Position - 0x2CC46
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_389(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)//Position - 0x2D07E
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
...
int func_396(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2DA08
{
	int iVar0;
...
bool func_397(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2DAF9
{
	struct<3> Var0;
...
int func_398(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2DB23
{
	int iVar0;
...
int func_416(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2EFC8
{
	struct<3> Var0;
	float fVar3;
...
int func_431(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2FAA7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_436(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2FC33
{
...
void func_450(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3011F
{
	if (func_535())
	{
...
void func_451(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x301B4
{
	int iVar0;
...
int func_452(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x30348
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_493(var uParam0, int iParam1, int iParam2)//Position - 0x3505D
{
...
void func_497(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x35169
{
	int iVar0;
...
int func_501(struct<3> Param0, float fParam3)//Position - 0x353A5
{
	return func_502(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_502(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x353BF
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_504(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x35734
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_505(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x3593C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_540(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)//Position - 0x36FCF
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_541(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x37040
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_542(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x370DF
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_543(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x37153
{
	switch (Param0.f_4)
	{
		case 0:
