...
int func_235(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x279DF
{
	bool bVar0;
	float fVar1;
...
int func_236(int* iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)//Position - 0x27A3B
{
...
void func_237(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x27AC6
{
	func_238(iParam0);
...
void func_251(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27F60
{
	int iVar0;
...
void func_254(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x28171
{
	struct<3> Var0;
	var uVar3;
...
void func_255(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x281EC
{
	struct<60> Var0;
...
void func_289(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2DE7F
{
	if (func_286(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_293(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2E11E
{
	if (bParam6)
	{
...
int func_299(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2E6FA
{
	int iVar0;
...
int func_300(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2E810
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_303(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2E8D0
{
	func_304(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_304(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2E8FA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_306(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2ED1A
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_307(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2F010
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_321(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2F525
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_344(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x3082D
{
...
int func_345(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x30889
{
	int iVar0;
