...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x89C8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_209(int iParam0, bool bParam1, bool bParam2)//Position - 0x22974
{
	if (iParam0 == -1)
	{
		return;
...
void func_213(bool bParam0, bool bParam1)//Position - 0x22B10
{
	if (bParam1)
	{
...
int func_242(struct<3> Param0, struct<3> Param3, int iParam6, float fParam7)//Position - 0x27824
{
...
int func_250(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27DAB
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_251(struct<3> Param0, struct<3> Param3)//Position - 0x27E39
{
...
int func_257(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x28032
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
void func_280(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x28C24
{
	struct<3> Var0;
	var uVar3;
...
void func_281(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x28C9F
{
	struct<60> Var0;
...
void func_315(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2E930
{
	if (func_312(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_319(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2EBCF
{
	if (bParam6)
	{
...
int func_325(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2F1AB
{
	int iVar0;
...
int func_326(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2F2C1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_329(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2F381
{
	func_330(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_330(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2F3AA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_332(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2F7CA
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_333(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2FAC0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_335(struct<3> Param0, int iParam3)//Position - 0x2FBD9
{
	return func_336(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_336(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2FBF6
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_338(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2FC77
{
	int iVar0;
...
int func_367(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x30B38
{
...
int func_368(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x30B94
{
	int iVar0;
...
void func_370(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x30C68
{
	func_4(iParam0);
...
void func_377(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30E70
{
	if (func_464())
	{
...
void func_378(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x30F05
{
	int iVar0;
...
int func_379(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x31099
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_422(var uParam0, int iParam1, int iParam2)//Position - 0x35E8A
{
...
void func_426(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x35F96
{
	int iVar0;
...
int func_430(struct<3> Param0, float fParam3)//Position - 0x361D2
{
	return func_431(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_431(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x361EC
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_433(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x36562
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_434(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x3676A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
