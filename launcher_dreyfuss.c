...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5BC4
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6387
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6830
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x718E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_173(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xB792
{
	struct<3> Var0;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC9A8
{
	var uVar0;
...
int func_216(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDE94
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_220(struct<3> Param0, struct<3> Param3)//Position - 0xE160
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_228(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE4DE
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x12E4D
{
	func_251(iParam0);
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x12F2B
{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x12F87
{
	int iVar0;
...
int func_268(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x134F4
{
	int iVar0;
...
int func_269(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x13559
{
	int iVar0;
	struct<7> Var1;
...
int func_270(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x135D1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
