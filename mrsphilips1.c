...
int func_219(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x26FD8
{
	bool bVar0;
	float fVar1;
...
void func_220(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27034
{
	int iVar0;
...
void func_236(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x27697
{
	float fVar0;
	int iVar1;
	int iVar2;
