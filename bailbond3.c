...
int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x1362
{
...
int func_57(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1435
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
bool func_59(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x150B
{
...
void func_104(struct<3> Param0, float fParam3)//Position - 0x29A4
{
	func_105(&(Global_106934.f_2890), Param0, fParam3);
}

void func_105(var uParam0, struct<3> Param1, var uParam4)//Position - 0x29BD
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_106(struct<3> Param0, float fParam3)//Position - 0x29D3
{
...
bool func_107(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x29FF
{
	if (bParam6)
	{
...
bool func_116(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E9E
{
...
void func_135(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3ABD
{
	struct<3> Var0;
	var uVar3;
...
void func_136(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3B38
{
	struct<60> Var0;
...
void func_172(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x993A
{
	if (func_169(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_174(int iParam0, bool bParam1, bool bParam2)//Position - 0x9A90
{
	if (iParam0 == -1)
	{
		return;
...
int func_185(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xA2D6
{
	int iVar0;
...
int func_186(struct<3> Param0, int iParam3, int iParam4)//Position - 0xA3EC
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_189(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xA4AC
{
	func_190(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_190(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xA4D5
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_192(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xA8F5
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_193(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xABEB
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_196(struct<3> Param0, int iParam3)//Position - 0xAD43
{
	return func_197(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_197(int iParam0, struct<3> Param1, int iParam4)//Position - 0xAD60
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_201(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0xAE2F
{
	int iVar0;
...
int func_252(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x14630
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_328(int iParam0, struct<3> Param1, int iParam4, float fParam5)//Position - 0x2975E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_332(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x29A2B
{
	int iVar0;
...
int func_333(int iParam0, struct<3> Param1, float fParam4, float fParam5)//Position - 0x29BA3
{
...
void func_337(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x29C72
{
...
void func_338(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x29CAA
{
	int iVar0;
	int iVar1;
...
void func_353(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2A649
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_381(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2CA3E
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_385(struct<3> Param0, struct<3> Param3)//Position - 0x2CD0A
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_391(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)//Position - 0x2D142
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
...
int func_398(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2DAEB
{
	int iVar0;
...
bool func_399(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2DBDD
{
	struct<3> Var0;
...
int func_400(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2DC07
{
	int iVar0;
...
int func_411(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2E9C6
{
	struct<3> Var0;
	float fVar3;
...
int func_426(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2F516
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_431(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2F6A2
{
...
void func_445(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2FB77
{
	if (func_530())
	{
...
void func_446(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2FC0C
{
	int iVar0;
...
int func_447(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2FDA0
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_488(var uParam0, int iParam1, int iParam2)//Position - 0x34AB9
{
...
void func_492(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x34BC5
{
	int iVar0;
...
int func_496(struct<3> Param0, float fParam3)//Position - 0x34E01
{
	return func_497(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_497(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x34E1B
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_499(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x35190
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_500(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x35398
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_535(var uParam0, int iParam1, struct<3> Param2, int iParam5, int iParam6, bool bParam7)//Position - 0x36830
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_56(iParam6))
...
int func_536(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x368A1
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_56(iParam1))
...
Vector3 func_537(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x36940
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_538(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x369B4
{
	switch (Param0.f_4)
	{
		case 0:
