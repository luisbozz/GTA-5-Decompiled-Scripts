...
void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x667C
{
	if (func_54(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_60(int iParam0, bool bParam1, bool bParam2)//Position - 0x67D2
{
	if (iParam0 == -1)
	{
		return;
...
bool func_78(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x71C4
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_79(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x71E2
{
	if (bParam6)
	{
...
int func_190(struct<3> Param0, bool bParam3)//Position - 0xB6AB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_192(struct<3> Param0, bool bParam3)//Position - 0xB75A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_194(struct<3> Param0, struct<3> Param3)//Position - 0xB85D
{
	float fVar0;
...
int func_196(struct<3> Param0, int iParam3)//Position - 0xBEF3
{
	float fVar0;
...
int func_205(struct<3> Param0, int iParam3, int iParam4)//Position - 0xC92B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
struct<8> func_264(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xFCC7
{
	struct<8> Var0;
