...
Vector3 func_105(char* sParam0)//Position - 0x2FBC
{
	struct<3> Var0;
...
Vector3 func_106(char* sParam0, char* sParam1)//Position - 0x303A
{
	struct<3> Var0;
	var* uVar3;
...
Vector3 func_107(char* sParam0)//Position - 0x30FD
{
	struct<3> Var0;
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x4E5A
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_215(struct<3> Param0, int iParam3, float fParam4)//Position - 0x21EB4
{
	int iVar0;
	struct<3> Var1[3];
	struct<3> Var11[3];
...
int func_287(struct<2> Param0, var uParam2, struct<3> Param3, float fParam6)//Position - 0x25790
{
	if (!func_65(Param3))
	{
