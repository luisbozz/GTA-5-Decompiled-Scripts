...
int func_45(int iParam0, int iParam1, int iParam2, struct<3> Param3, float fParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x1BB5
{
	int iVar0;
...
int func_57(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x1F98
{
...
int func_58(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x204B
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
Vector3 func_75(struct<3> Param0, float fParam3)//Position - 0x5A0F
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
