...
void func_77(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2C76
{
	int iVar0;
...
void func_198(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x21040
{
	func_199(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_199(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x21069
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_203(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x215D0
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_204(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x218C6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_216(struct<3> Param0, bool bParam3)//Position - 0x221E5
{
	return func_217(Param0, bParam3);
}

int func_217(struct<3> Param0, bool bParam3)//Position - 0x221F7
{
	int iVar0;
...
bool func_221(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x222D8
{
...
int func_280(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x26437
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_281(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x267D1
{
	if (bParam6)
	{
