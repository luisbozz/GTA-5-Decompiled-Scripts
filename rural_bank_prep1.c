...
void func_120(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x85E0
{
	struct<3> Var0;
	var uVar3;
...
void func_121(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x865B
{
	struct<60> Var0;
...
void func_137(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xA510
{
	if (func_134(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_139(int iParam0, bool bParam1, bool bParam2)//Position - 0xA666
{
	if (iParam0 == -1)
	{
		return;
...
bool func_143(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xA804
{
	if (bParam6)
	{
...
int func_145(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xA872
{
	int iVar0;
...
int func_146(struct<3> Param0, int iParam3, int iParam4)//Position - 0xA988
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_156(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0xB3DD
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
...
float func_177(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDCB9
{
	struct<3> Var0;
...
float func_184(struct<3> Param0, struct<3> Param3)//Position - 0xEA1C
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_186(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, bool bParam10)//Position - 0xEA7C
{
	int iVar0;
...
void func_212(struct<3> Param0, float fParam3)//Position - 0x10E04
{
...
void func_216(struct<3> Param0, float fParam3)//Position - 0x11057
{
...
void func_219(struct<3> Param0, float fParam3)//Position - 0x112D1
{
...
int func_228(var uParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x120F6
{
...
void func_245(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x12A8D
{
	int iVar0;
	int iVar1;
...
void func_260(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x1346C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_273(bool bParam0)//Position - 0x13D7E
{
...
int func_302(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x17541
{
	int iVar0;
	int iVar1;
...
int func_310(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x18168
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_315(struct<3> Param0, float fParam3)//Position - 0x18AC6
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_341(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x1C203
{
	if (func_211())
	{
