...
void func_98(int* iParam0, char* sParam1, char* sParam2, int iParam3, struct<3> Param4, struct<3> Param7)//Position - 0x6349
{
...
bool func_115(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7EF8
{
	if (bParam6)
	{
...
void func_122(var uParam0, bool bParam1, struct<3> Param2, float fParam5, int* iParam6, bool bParam7)//Position - 0x8AEB
{
...
void func_123(int* iParam0, char* sParam1, char* sParam2, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)//Position - 0x8C0F
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_144(bool bParam0, bool bParam1, int iParam2)//Position - 0x960F
{
	switch (iParam0)
	{
		case 5:
