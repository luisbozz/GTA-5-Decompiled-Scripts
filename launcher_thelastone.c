...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5BA0
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6363
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x680C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x716A
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_186(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xC84C
{
	var uVar0;
...
float func_192(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCA7E
{
	struct<3> Var0;
...
void func_193(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)//Position - 0xCAB8
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_216(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDE1D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_220(struct<3> Param0, struct<3> Param3)//Position - 0xE0E9
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_228(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE467
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE9DD
{
	func_242(iParam0);
...
int func_254(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEEEE
{
	int iVar0;
...
int func_255(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xEF53
{
	int iVar0;
	struct<7> Var1;
...
int func_256(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xEFCB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
