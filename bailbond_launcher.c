...
int func_114(int iParam0, bool bParam1)//Position - 0x6BE2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x7FBD
{
	int iVar0;
	int iVar1;
...
bool func_121(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8782
{
	if (bParam6)
	{
...
int func_128(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x8C2B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_133(struct<3> Param0, float fParam3)//Position - 0x9589
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
