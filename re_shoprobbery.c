...
void func_3(int iParam0, bool bParam1, bool bParam2)//Position - 0x1679
{
	int iVar0;
...
int func_202(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xEAEC
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_203(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xEE86
{
	if (bParam6)
	{
