...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x811D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_187(int iParam0, bool bParam1, bool bParam2)//Position - 0x22051
{
	if (iParam0 == -1)
	{
		return;
...
void func_191(bool bParam0, bool bParam1)//Position - 0x221ED
{
	if (bParam1)
	{
...
int func_239(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x276C7
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_243(struct<3> Param0, struct<3> Param3)//Position - 0x27993
{
...
int func_252(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27D58
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_259(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2815E
{
	int iVar0;
...
void func_270(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28603
{
	func_271(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_271(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2862C
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_275(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28B92
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_276(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x28E88
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_302(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2990A
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2A748
{
...
int func_322(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2A7A4
{
	int iVar0;
...
void func_331(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2AAD9
{
	int iVar0;
...
int func_332(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2AC6D
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_395(var uParam0, int iParam1, int iParam2)//Position - 0x33C4B
{
...
void func_401(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x33FF5
{
	int iVar0;
...
bool func_407(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x359EC
{
	if (bParam6)
	{
...
int func_408(struct<3> Param0, float fParam3)//Position - 0x35A33
{
	return func_409(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_409(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x35A4D
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_411(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x35DC2
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_412(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x35FCA
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
