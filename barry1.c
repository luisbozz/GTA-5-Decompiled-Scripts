...
void func_55(struct<3> Param0, float fParam3)//Position - 0x1AC0
{
	func_56(&(Global_106934.f_2890), Param0, fParam3);
}

void func_56(var uParam0, struct<3> Param1, var uParam4)//Position - 0x1AD9
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_57(struct<3> Param0, float fParam3)//Position - 0x1AEF
{
...
bool func_58(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1B1B
{
	if (bParam6)
	{
...
int func_151(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xA964
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_255(int iParam0, bool bParam1, bool bParam2)//Position - 0x2486A
{
	if (iParam0 == -1)
	{
		return;
...
void func_259(bool bParam0, bool bParam1)//Position - 0x24A06
{
	if (bParam1)
	{
...
void func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x293A7
{
	func_14(iParam0);
...
void func_283(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x293CE
{
	int iVar0;
...
void func_287(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x29671
{
	struct<60> Var0;
...
void func_322(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2F31E
{
	if (func_319(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_331(struct<3> Param0, int iParam3)//Position - 0x2FB52
{
	return func_332(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_332(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2FB6F
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_344(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2FFE2
{
	int iVar0;
	int iVar1;
...
bool func_357(struct<3> Param0, float fParam3, int iParam4, bool bParam5)//Position - 0x30567
{
	return MISC::IS_POSITION_OCCUPIED(Param0, fParam3, false, false, true, false, false, iParam4, bParam5);
}

bool func_358(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x30582
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

Vector3 func_359(struct<3> Param0, float fParam3, float fParam4)//Position - 0x305A0
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_360(struct<3> Param0, float fParam3)//Position - 0x305E8
{
	float fVar0;
...
int func_362(var uParam0, struct<3> Param1, int iParam4, bool bParam5)//Position - 0x30653
{
	if (bParam5)
	{
...
float func_365(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5, int iParam6)//Position - 0x30946
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_387(struct<3> Param0, float fParam3, int iParam4, bool bParam5)//Position - 0x310CC
{
	int iVar0;
	struct<3> Var1;
...
int func_388(struct<3> Param0, float fParam3, var uParam4)//Position - 0x3114E
{
	if (iLocal_181 == 0)
	{
		return 0;
...
int func_415(var uParam0, bool bParam1)//Position - 0x31B86
{
...
void func_422(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x32424
{
	func_423(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_423(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3244E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_425(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3286E
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_426(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x32B64
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_451(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x354D4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_453(struct<3> Param0, struct<3> Param3, int iParam6)//Position - 0x359A9
{
...
int func_457(struct<3> Param0, struct<3> Param3, struct<3> Param6)//Position - 0x35BD3
{
	float fVar0;
...
float func_458(struct<3> Param0, struct<3> Param3)//Position - 0x35C08
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

int func_459(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10)//Position - 0x35C29
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_462(struct<3> Param0, struct<3> Param3, var uParam6, var uParam7, int iParam8)//Position - 0x35CFF
{
	struct<3> Var0;
...
void func_463(struct<3> Param0, var uParam3, var uParam4, int iParam5)//Position - 0x35D22
{
	float fVar0;
...
void func_483(char* sParam0, char* sParam1, struct<3> Param2, int iParam5)//Position - 0x36C3E
{
...
void func_492(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x36E3A
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_510(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x378A4
{
	struct<3> Var0;
...
void func_515(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x37C00
{
	if (func_525())
	{
...
int func_517(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x380FA
{
...
int func_518(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x38156
{
	int iVar0;
...
void func_527(bool bParam0, bool bParam1)//Position - 0x38346
{
	if (bParam1)
	{
...
void func_531(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3851F
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_537(int iParam0, bool bParam1, bool bParam2)//Position - 0x38683
{
	int iVar0;
...
void func_539(int iParam0, bool bParam1, bool bParam2)//Position - 0x38A70
{
	int iVar0;
