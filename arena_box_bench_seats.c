...
int func_22(bool bParam0)//Position - 0xA49
{
	if (bParam0 != func_23())
	{
...
void func_32(int* iParam0, bool bParam1)//Position - 0xD07
{
...
void func_99(int* iParam0, bool bParam1, bool bParam2)//Position - 0x3FFB
{
	if (bParam2)
	{
...
void func_120(int* iParam0, bool bParam1)//Position - 0x4C9F
{
	MISC::SET_BIT(iParam0, iParam1);
}
