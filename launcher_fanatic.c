...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C4C
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x640F
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68B8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x7216
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_192(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD0D7
{
	var uVar0;
...
float func_196(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD28B
{
	struct<3> Var0;
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xD2C5
{
	var uVar0;
...
int func_224(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE724
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_228(struct<3> Param0, struct<3> Param3)//Position - 0xE9F0
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_236(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xED6E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF54C
{
...
int func_251(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF5A8
{
	int iVar0;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA57
{
	func_259(iParam0);
...
void func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFB35
{
	func_261(iParam0);
...
int func_273(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x100F4
{
	int iVar0;
...
int func_274(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10159
{
	int iVar0;
	struct<7> Var1;
...
int func_275(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x101D1
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
