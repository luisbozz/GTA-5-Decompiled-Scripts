...
void func_6(bool bParam0)//Position - 0x32C
{
...
void func_16(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x5FD
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_34(bool bParam0, bool bParam1, int iParam2)//Position - 0xD95
{
	switch (bParam0)
	{
		case 5:
...
bool func_100(var uParam0, bool bParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x3009
{
...
bool func_102(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8329
{
	if (bParam6)
	{
...
int func_146(var uParam0, int iParam1, int iParam2)//Position - 0xA84F
{
...
int func_156(bool bParam0, int iParam1)//Position - 0xAB14
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x17C2C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_278(bool bParam0, int iParam1)//Position - 0x32FAF
{
...
void func_295(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3331B
{
