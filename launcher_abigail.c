...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C0E
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x63D1
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x687A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x71D8
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_172(struct<3> Param0, bool bParam3)//Position - 0xBB77
{
	int iVar0;
...
int func_190(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCE01
{
	var uVar0;
...
float func_194(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCFB5
{
	struct<3> Var0;
...
int func_231(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xECB3
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_235(struct<3> Param0, struct<3> Param3)//Position - 0xEF7F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_243(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF2FD
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_256(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF861
{
	func_257(iParam0);
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF93F
{
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF99B
{
	int iVar0;
...
int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFFE9
{
	int iVar0;
...
int func_275(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10050
{
	int iVar0;
	struct<7> Var1;
...
int func_276(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x100C8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
