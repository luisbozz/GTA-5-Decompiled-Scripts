...
bool func_53(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x225A
{
	if (bParam6)
	{
...
int func_57(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2395
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		func_61(0);
