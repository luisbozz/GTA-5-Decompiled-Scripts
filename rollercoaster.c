...
int func_52(var uParam0, bool bParam1)//Position - 0x397F
{
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xD45E
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
