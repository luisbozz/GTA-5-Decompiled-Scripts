...
Vector3 func_84(char* sParam0)//Position - 0x38B7
{
	struct<3> Var0;
...
Vector3 func_85(char* sParam0, char* sParam1)//Position - 0x393D
{
	struct<3> Var0;
	var* uVar3;
...
Vector3 func_86(char* sParam0)//Position - 0x3A09
{
	struct<3> Var0;
...
void func_167(struct<36> Param0, int iParam36)//Position - 0x5E32
{
	char cVar0[64];
	char cVar16[64];
	char cVar32[64];
...
void func_169(struct<36> Param0, int iParam36)//Position - 0x66C7
{
	int iVar0;
...
void func_170(struct<36> Param0, int iParam36)//Position - 0x672A
{
	int iVar0;
	var uVar1;
	char cVar17[24];
...
int func_221(struct<7> Param0, struct<7> Param7, int iParam14)//Position - 0xBD7A
{
	int iVar0;
	int iVar1;
...
var func_232(struct<7> Param0, int iParam7)//Position - 0xC0D1
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var func_242(struct<6> Param0, var uParam6)//Position - 0xC4DC
{
	var uVar0;
...
int func_275(struct<6> Param0, struct<6> Param6)//Position - 0xDD48
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_310(struct<6> Param0, struct<6> Param6)//Position - 0xF488
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
