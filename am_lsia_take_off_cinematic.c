...
bool func_97(var uParam0, bool bParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x2EFE
{
...
bool func_99(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x821E
{
	if (bParam6)
	{
...
int func_143(var uParam0, int iParam1, int iParam2)//Position - 0xA744
{
...
int func_153(bool bParam0, int iParam1)//Position - 0xAA09
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x17B40
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_276(bool bParam0, int iParam1)//Position - 0x32FAF
{
...
void func_288(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x33183
{
