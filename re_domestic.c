...
void func_5(int iParam0, bool bParam1, bool bParam2)//Position - 0x70C
{
	int iVar0;
...
int func_121(struct<3> Param0, bool bParam3)//Position - 0x4F6D
{
	int iVar0;
...
float func_133(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x593B
{
...
int func_183(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9430
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_184(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x97CA
{
	if (bParam6)
	{
