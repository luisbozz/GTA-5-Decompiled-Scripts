...
int func_135(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x7785
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_139(struct<3> Param0, struct<3> Param3)//Position - 0x7A51
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_148(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x7E16
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_153(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x7F5A
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
...
void func_154(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x7F92
{
	int iVar0;
	int iVar1;
...
void func_168(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x891C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_179(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x905C
{
	struct<3> Var0;
...
int func_234(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xD03C
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
void func_308(int iParam0, bool bParam1)//Position - 0xFF95
{
