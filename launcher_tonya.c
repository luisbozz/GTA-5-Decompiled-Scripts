...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C35
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x63F8
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68A1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x71FF
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_212(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xE111
{
	struct<3> Var0;
...
int func_232(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xF27F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_236(struct<3> Param0, struct<3> Param3)//Position - 0xF54B
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_244(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF8C9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_267(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10392
{
	int iVar0;
...
int func_268(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x103F7
{
	int iVar0;
	struct<7> Var1;
...
int func_269(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1046F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
