...
struct<5> func_3(int iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x214
{
	struct<5> Var0;
	int iVar5;
	struct<5> Var6;
...
bool func_6(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x3FF
{
	if (bParam6)
	{
