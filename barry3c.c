...
int func_287(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C1EB
{
	int iVar0;
	int iVar1;
...
bool func_289(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2C9AE
{
	if (bParam6)
	{
...
int func_295(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2CE4C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_300(struct<3> Param0, float fParam3)//Position - 0x2D7AA
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_335(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2F773
{
	int iVar0;
...
void func_343(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2FCB7
{
	struct<3> Var0;
	var uVar3;
...
void func_344(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x2FD32
{
	struct<60> Var0;
...
void func_363(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x352FA
{
	if (func_362(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_367(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x3555D
{
	int iVar0;
...
int func_368(struct<3> Param0, int iParam3, int iParam4)//Position - 0x35673
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_401(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x3667C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_423(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x373DD
{
	if (func_418(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam4)
...
void func_426(struct<3> Param0, float fParam3)//Position - 0x37521
{
...
void func_435(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x377B5
{
	if (func_454())
	{
...
int func_439(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x378CF
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
struct<7> func_467(struct<3> Param0, float fParam3)//Position - 0x38A5B
{
	struct<7> Var0;
