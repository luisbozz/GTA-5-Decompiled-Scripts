...
int func_31(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x130A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_32(struct<3> Param0, struct<3> Param3)//Position - 0x1398
{
...
int func_39(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x15B0
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
void func_57(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x1F28
{
	func_58(&(Param0.f_1));
	func_55(&Param0);
}
...
void func_91(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2E15
{
	int iVar0;
...
int func_142(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xC615
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_210(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x210A1
{
	func_211(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_211(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x210CB
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_215(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x21631
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_216(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x21927
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_222(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x21B28
{
...
bool func_226(int iParam0, struct<3> Param1, float fParam4)//Position - 0x21DFE
{
	struct<3> Var0;
	struct<3> Var3;
...
float func_247(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x23B1B
{
	struct<3> Var0;
...
bool func_257(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x24921
{
...
void func_262(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x24B78
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_281(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x25A4E
{
	int iVar0;
	int iVar1;
...
void func_340(int iParam0, bool bParam1, bool bParam2)//Position - 0x29136
{
	if (iParam0 == -1)
	{
		return;
...
void func_344(bool bParam0, bool bParam1)//Position - 0x292D2
{
	if (bParam1)
	{
...
void func_368(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2DDE3
{
	int iVar0;
...
int func_369(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2DF77
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_432(var uParam0, int iParam1, int iParam2)//Position - 0x36F81
{
...
void func_438(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x37330
{
	int iVar0;
...
bool func_444(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x38D28
{
	if (bParam6)
	{
...
int func_445(struct<3> Param0, float fParam3)//Position - 0x38D6F
{
	return func_446(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_446(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x38D89
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_448(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x390FF
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_449(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x39307
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_499(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3AF14
{
	if (func_503())
	{
...
void func_518(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3B791
{
...
void func_538(bool bParam0, bool bParam1)//Position - 0x3BE65
{
	if (bParam1)
	{
