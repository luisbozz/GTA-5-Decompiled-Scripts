...
int func_63(int iParam0, bool bParam1)//Position - 0x4AA0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_68(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5E7B
{
	int iVar0;
	int iVar1;
...
bool func_70(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x663E
{
	if (bParam6)
	{
...
int func_77(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6AE7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_82(struct<3> Param0, float fParam3)//Position - 0x7445
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_148(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x9B2D
{
	float fVar0;
	int iVar1;
	int iVar2;
