...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x7FDC
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_182(int iParam0, bool bParam1, bool bParam2)//Position - 0x22051
{
	if (iParam0 == -1)
	{
		return;
...
void func_186(bool bParam0, bool bParam1)//Position - 0x221ED
{
	if (bParam1)
	{
...
float func_218(struct<3> Param0, struct<3> Param3)//Position - 0x2716A
{
...
bool func_220(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x271CA
{
...
float func_241(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x27B26
{
	struct<3> Var0;
...
void func_265(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x28660
{
	int iVar0;
...
void func_268(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28870
{
	func_269(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_269(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28899
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_273(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28DFF
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_274(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x290F5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_305(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A926
{
	if (func_474())
	{
...
int func_306(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2A9BB
{
	bool bVar0;
	float fVar1;
...
int func_315(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2AE17
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_325(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2B3B7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_335(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B6DC
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_418(var uParam0, int iParam1, int iParam2)//Position - 0x3532F
{
...
void func_424(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x356D9
{
	int iVar0;
...
bool func_430(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x370CF
{
	if (bParam6)
	{
...
int func_431(struct<3> Param0, float fParam3)//Position - 0x37116
{
	return func_432(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_432(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x37130
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_434(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x374A5
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_435(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x376AD
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_465(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x3865C
{
	func_466(iParam0);
...
int func_467(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x386AE
{
...
int func_468(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3870A
{
	int iVar0;
