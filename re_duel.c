...
int func_68(int iParam0, struct<3> Param1, float fParam4)//Position - 0x6737
{
...
float func_77(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x6B10
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3.f_0 - Param0.f_0), (Param3.f_1 - Param0.f_1));
}

int func_78(struct<3> Param0, float fParam3)//Position - 0x6B2A
{
	int iVar0;
	int iVar1;
...
float func_82(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x6C49
{
	struct<3> Var0;
...
int func_83(int iParam0, bool bParam1, struct<3> Param2, float fParam5)//Position - 0x6C83
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
bool func_87(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7543
{
	if (bParam6)
	{
...
int func_95(struct<3> Param0, float fParam3)//Position - 0x7B4D
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_107(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x8146
{
	struct<3> Var0;
	float fVar3;
	int iVar4;
...
int func_158(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB90A
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
