...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x8162
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_183(int iParam0, bool bParam1, bool bParam2)//Position - 0x222B4
{
	if (iParam0 == -1)
	{
		return;
...
void func_187(bool bParam0, bool bParam1)//Position - 0x22450
{
	if (bParam1)
	{
...
float func_211(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x26FB7
{
	struct<3> Var0;
...
int func_247(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x28B48
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_251(struct<3> Param0, struct<3> Param3)//Position - 0x28E14
{
...
int func_260(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x291D9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_278(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x29EB5
{
	int iVar0;
...
void func_283(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2A118
{
	func_284(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_284(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2A142
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_288(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2A6B0
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_289(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2A9A6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_312(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B890
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_333(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2C67F
{
	bool bVar0;
	float fVar1;
...
void func_335(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2C6EC
{
	int iVar0;
...
int func_336(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2C880
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_399(var uParam0, int iParam1, int iParam2)//Position - 0x35BB9
{
...
void func_405(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x35F68
{
	int iVar0;
...
bool func_411(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x3795F
{
	if (bParam6)
	{
...
int func_412(struct<3> Param0, float fParam3)//Position - 0x379A6
{
	return func_413(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_413(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x379C0
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_415(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x37D36
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_416(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x37F3E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_457(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x39884
{
	func_235(iParam0);
...
void func_458(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x398C6
{
	func_236(iParam0);
	*iParam0 = PED::CREATE_PED(iParam6, iParam1, Param2, fParam5, false, false);
}

int func_459(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x398E7
{
...
int func_460(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x39943
{
	int iVar0;
...
void func_466(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x39AD3
{
	if (func_467())
	{
