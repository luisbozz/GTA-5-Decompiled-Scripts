...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x80C4
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_183(int iParam0, bool bParam1, bool bParam2)//Position - 0x22051
{
	if (iParam0 == -1)
	{
		return;
...
void func_187(bool bParam0, bool bParam1)//Position - 0x221ED
{
	if (bParam1)
	{
...
void func_235(int iParam0, struct<2> Param1, float fParam3)//Position - 0x27BA2
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_239(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27CCD
{
	int iVar0;
...
int func_358(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2F4EB
{
	int iVar0;
	int iVar1;
...
bool func_360(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2FCAE
{
	if (bParam6)
	{
...
int func_366(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x3014E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_371(struct<3> Param0, float fParam3)//Position - 0x30AAC
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
bool func_402(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x32670
{
...
int func_421(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x33149
{
	int iVar0;
...
void func_436(struct<3> Param0, float fParam3, int iParam4)//Position - 0x33A04
{
...
int func_438(int* iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6)//Position - 0x33A73
{
...
void func_439(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x33AFE
{
	func_440(iParam0);
...
void func_443(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x33CBF
{
	struct<3> Var0;
	var uVar3;
...
void func_444(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x33D3A
{
	struct<60> Var0;
...
void func_463(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x392FF
{
	if (func_462(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_467(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x39562
{
	int iVar0;
...
int func_468(struct<3> Param0, int iParam3, int iParam4)//Position - 0x39678
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_471(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x39738
{
	func_472(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_472(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x39762
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_474(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x39B82
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_475(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x39E78
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_510(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x3B18C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_514(struct<3> Param0, struct<3> Param3)//Position - 0x3B458
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_522(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x3B7DE
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_528(struct<3> Param0, float fParam3)//Position - 0x3BB01
{
...
void func_532(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x3BBAD
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_549(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x3C717
{
	int iVar0;
	int iVar1;
...
void func_553(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3C86A
{
	if (func_564())
	{
...
int func_560(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x3CE1F
{
...
int func_561(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3CE7B
{
	int iVar0;
...
void func_569(int iParam0, bool bParam1, bool bParam2)//Position - 0x3D40A
{
	int iVar0;
...
void func_570(int iParam0, bool bParam1, bool bParam2)//Position - 0x3D47C
{
	int iVar0;
...
void func_580(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x3D9B0
{
	iParam0->f_1 = iParam1;
	iParam0->f_2 = { Param2 };
	iParam0->f_5 = fParam5;
