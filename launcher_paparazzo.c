...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C0D
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x63D0
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6879
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x71D7
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_172(struct<3> Param0, bool bParam3)//Position - 0xBB72
{
	int iVar0;
...
float func_194(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCFFD
{
	struct<3> Var0;
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD16A
{
	var uVar0;
...
int func_218(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE31F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_222(struct<3> Param0, struct<3> Param3)//Position - 0xE5EB
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_230(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE969
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF36A
{
	func_209(iParam0);
...
void func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF391
{
	func_246(iParam0);
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF46F
{
	func_248(iParam0);
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF4D1
{
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF52D
{
	int iVar0;
...
int func_269(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10787
{
	int iVar0;
...
int func_270(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x107EC
{
	int iVar0;
	struct<7> Var1;
...
int func_271(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10864
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
