...
void func_86(int iParam0, bool bParam1)//Position - 0x4FC9
{
	if (iParam0 == -1)
	{
		iParam0 = func_104();
...
int func_94(int iParam0, bool bParam1)//Position - 0x5705
{
	switch (iParam0)
	{
		case 0:
...
void func_102(int iParam0, bool bParam1)//Position - 0x5E79
{
...
int func_170(struct<3> Param0, bool bParam3)//Position - 0x9753
{
...
void func_185(struct<3> Param0, bool bParam3)//Position - 0xB3E8
{
...
void func_216(int iParam0, bool bParam1, bool bParam2)//Position - 0xDAC5
{
	int iVar0;
...
void func_218(int iParam0, bool bParam1, bool bParam2)//Position - 0xDEB2
{
	int iVar0;
...
int func_237(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xE633
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_238(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xE9CD
{
	if (bParam6)
	{
