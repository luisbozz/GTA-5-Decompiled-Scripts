...
int func_70(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C6F
{
	int iVar0;
	int iVar1;
...
bool func_72(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6432
{
	if (bParam6)
	{
...
int func_79(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68DB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_84(struct<3> Param0, float fParam3)//Position - 0x7239
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_166(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xBE97
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_170(struct<3> Param0, struct<3> Param3)//Position - 0xC164
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_178(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC4E2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_268(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xFF5D
{
	struct<3> Var0;
...
int func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x106B3
{
	int iVar0;
	var uVar1;
	int iVar8;
...
int func_288(struct<7> Param0, struct<7> Param7, int iParam14)//Position - 0x194EB
{
	int iVar0;
	int iVar1;
...
var func_295(struct<7> Param0, int iParam7)//Position - 0x19759
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var func_299(struct<6> Param0, var uParam6)//Position - 0x199A9
{
	var uVar0;
...
void func_309(char* sParam0, char[8] cParam1, char[4] cParam3, char[4] cParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12)//Position - 0x19ED3
{
...
int func_337(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1DCA2
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_339(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x1DD1B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_345(struct<3> Param0, float fParam3)//Position - 0x1E404
{
	struct<3> Var0;
...
void func_348(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x1E781
{
	func_156(iParam0);
...
int func_356(int iParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x1EDA3
{
	int iVar0;
...
int func_357(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x1EE08
{
	int iVar0;
	struct<7> Var1;
...
int func_358(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1EE80
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
