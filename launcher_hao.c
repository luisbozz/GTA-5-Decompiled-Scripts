...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C3C
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x63FF
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68A8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x7206
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_185(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC92F
{
	var uVar0;
...
float func_189(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCAE3
{
	struct<3> Var0;
...
int func_201(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xD220
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_216(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDF55
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_220(struct<3> Param0, struct<3> Param3)//Position - 0xE221
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_228(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE59F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_240(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xECF6
{
	func_200(iParam0);
...
void func_241(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xED1D
{
	func_242(iParam0);
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEDFB
{
...
int func_244(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEE57
{
	int iVar0;
...
int func_258(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF3C6
{
	int iVar0;
...
int func_259(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF42B
{
	int iVar0;
	struct<7> Var1;
...
int func_260(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF4A3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
