...
int func_134(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x7BCB
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_135(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7F65
{
	if (bParam6)
	{
