...
void func_3(bool bParam0, bool bParam1)//Position - 0x36AB
{
	int iVar0;
	char* sVar1;
...
var func_15(bool bParam0)//Position - 0x3CC4
{
...
int func_17(bool bParam0)//Position - 0x3DB5
{
...
void func_121(int iParam0, bool bParam1, bool bParam2)//Position - 0xAF5D
{
	int iVar0;
...
void func_124(int iParam0, bool bParam1, bool bParam2)//Position - 0xB355
{
	int iVar0;
...
int func_126(struct<3> Param0, float fParam3, int iParam4)//Position - 0xB428
{
...
int func_142(int iParam0, struct<7> Param1, var uParam8, var uParam9)//Position - 0xBE6F
{
	if (iParam0 == 1)
	{
...
void func_190(int iParam0, bool bParam1)//Position - 0xEB18
{
	if (iParam0 == -1)
	{
		iParam0 = func_197();
...
int func_193(int iParam0, bool bParam1)//Position - 0xF1C0
{
	switch (iParam0)
	{
		case 0:
...
void func_195(int iParam0, bool bParam1)//Position - 0xF576
{
...
int func_214(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xFC5A
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
void func_246(struct<9> Param0, int iParam9, bool bParam10)//Position - 0x10A0A
{
	int iVar0;
