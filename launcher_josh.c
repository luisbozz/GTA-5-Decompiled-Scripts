...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D29
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64EC
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6995
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x72F3
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_171(struct<3> Param0, bool bParam3)//Position - 0xBC6E
{
	int iVar0;
...
int func_208(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD8AB
{
	var uVar0;
...
float func_219(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xDD25
{
	struct<3> Var0;
...
int func_234(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xECE0
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_238(struct<3> Param0, struct<3> Param3)//Position - 0xEFAC
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_246(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF32A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFC0E
{
	func_262(iParam0);
...
void func_263(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFCEC
{
	func_264(iParam0);
...
int func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xFD4E
{
...
int func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xFDAA
{
	int iVar0;
...
int func_288(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10A58
{
	int iVar0;
...
int func_289(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10ABD
{
	int iVar0;
	struct<7> Var1;
...
int func_290(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x10B35
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
