...
void func_38(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1755
{
	if (func_249(iParam0))
	{
...
int func_39(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x177B
{
	bool bVar0;
	float fVar1;
...
int func_96(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3161
{
	switch (iParam0)
	{
		case 0:
...
int func_97(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x31C9
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_105(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x37D8
{
...
void func_108(int* iParam0, struct<3> Param1, bool bParam4, bool bParam5, char* sParam6)//Position - 0x3862
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_109(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x3891
{
	int iVar0;
...
void func_116(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3B37
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3CCB
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_185(var uParam0, int iParam1, int iParam2)//Position - 0xCED1
{
...
void func_191(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xD27B
{
	int iVar0;
...
void func_194(int iParam0, bool bParam1, bool bParam2)//Position - 0xD497
{
	if (iParam0 == -1)
	{
		return;
...
bool func_200(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xED29
{
	if (bParam6)
	{
...
int func_201(struct<3> Param0, float fParam3)//Position - 0xED70
{
	return func_202(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_202(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xED8A
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_204(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xF0FF
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
bool func_233(struct<3> Param0, int iParam3)//Position - 0x10065
{
	return func_234(Global_106934.f_2890.f_12.f_66, Param0, iParam3);
}

int func_234(int iParam0, struct<3> Param1, int iParam4)//Position - 0x10082
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_283(int iParam0, bool bParam1, bool bParam2)//Position - 0x11991
{
	int iVar0;
...
void func_288(int iParam0, bool bParam1, bool bParam2)//Position - 0x11B1E
{
	int iVar0;
...
void func_290(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x11E9F
{
	if (func_291())
	{
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x1207D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_365(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x29000
{
	bool bVar0;
	int iVar1;
	int iVar2;
