...
void func_94(var uParam0, var uParam1, bool bParam2)//Position - 0x3B3D
{
	int iVar0;
...
void func_100(var uParam0, bool bParam1)//Position - 0x3DB2
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_101(int iParam0, bool bParam1, bool bParam2)//Position - 0x3E24
{
...
void func_102(int* iParam0, bool bParam1, bool bParam2)//Position - 0x3F10
{
	if (bParam1 < 0 || bParam1 >= 64)
	{
		return;
