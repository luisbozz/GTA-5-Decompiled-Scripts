...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5BD1
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6394
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x683D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x719B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xCA7B
{
	var uVar0;
...
float func_196(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCD1A
{
	struct<3> Var0;
...
int func_220(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE08C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_224(struct<3> Param0, struct<3> Param3)//Position - 0xE358
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_232(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE6D6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_247(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xECCD
{
	func_248(iParam0);
...
int func_249(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEDAB
{
...
int func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEE07
{
	int iVar0;
...
int func_266(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF5F8
{
	int iVar0;
...
int func_267(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF65D
{
	int iVar0;
	struct<7> Var1;
...
int func_268(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF6D5
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
