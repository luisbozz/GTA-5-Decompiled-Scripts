...
int func_100(struct<6> Param0, struct<6> Param6)//Position - 0x48DA
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_113(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x5220
{
	if (iParam0 == iParam5)
	{
		return;
...
int func_124(struct<3> Param0, bool bParam3)//Position - 0x5776
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_132(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x59DB
{
	if (bParam6)
	{
