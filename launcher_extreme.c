...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5D5D
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6520
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x69C9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x7327
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_170(struct<3> Param0, bool bParam3)//Position - 0xBC7F
{
	int iVar0;
...
int func_193(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD03E
{
	var uVar0;
...
float func_197(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD1F2
{
	struct<3> Var0;
...
int func_222(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE591
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_226(struct<3> Param0, struct<3> Param3)//Position - 0xE85D
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_234(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEBDB
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_247(int* iParam0, struct<3> Param1, float fParam4)//Position - 0xF0BF
{
...
void func_248(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF0F1
{
	func_249(iParam0);
...
int func_254(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF37D
{
...
int func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF3D9
{
	int iVar0;
...
void func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF7B1
{
	func_259(iParam0);
...
int func_271(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFD7D
{
	int iVar0;
...
int func_272(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xFDE2
{
	int iVar0;
	struct<7> Var1;
...
int func_273(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xFE5A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
