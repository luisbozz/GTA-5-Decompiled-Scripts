...
int func_64(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x2545
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_65(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x25F8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
