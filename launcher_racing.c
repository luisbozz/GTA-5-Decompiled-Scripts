...
bool func_167(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x94B3
{
...
int func_189(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xAE21
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_193(struct<3> Param0, struct<3> Param3)//Position - 0xB0ED
{
...
int func_202(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xB4B2
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_207(struct<3> Param0, float fParam3)//Position - 0xB73C
{
	struct<3> Var0;
...
int func_215(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xBB78
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
