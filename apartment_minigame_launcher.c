...
void func_6(int* iParam0, bool bParam1, bool bParam2)//Position - 0x855
{
	bool bVar0;
...
int func_17(int* iParam0, bool bParam1, bool bParam2)//Position - 0xF7B
{
	bool bVar0;
...
int func_36(char* sParam0, int iParam1, struct<17> Param2, var uParam19, var uParam20, var uParam21, var uParam22, bool bParam23, int iParam24, bool bParam25, bool bParam26, bool bParam27)//Position - 0x1D52
{
...
int func_44(var uParam0, bool bParam1, bool bParam2)//Position - 0x1F44
{
	bool bVar0;
...
void func_47(struct<21> Param0, bool bParam21)//Position - 0x207F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_102(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x7981
{
...
var func_104(struct<13> Param0, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, int iParam21)//Position - 0x79DF
{
	if (PAD::_IS_USING_KEYBOARD(2))
	{
		switch (iParam21)
...
void func_148(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x8C3B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_147();
