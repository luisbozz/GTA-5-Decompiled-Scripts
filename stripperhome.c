...
float func_25(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x7FA
{
	struct<3> Var0;
...
int func_62(struct<3> Param0, bool bParam3)//Position - 0x192D
{
	int iVar0;
...
int func_210(var uParam0, struct<3> Param1, bool bParam4, float fParam5)//Position - 0x6771
{
	if (func_212(uParam0))
	{
