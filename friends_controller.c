...
int func_69(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x285C
{
	char* sVar0;
	char[] cVar4[8];
...
int func_104(struct<3> Param0, float fParam3)//Position - 0x458E
{
	struct<3> Var0;
...
void func_105(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x45C0
{
	int iVar0;
...
int func_157(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xDF70
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_260(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x248E3
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_264(struct<3> Param0, struct<3> Param3)//Position - 0x24BAF
{
...
bool func_270(int iParam0, struct<3> Param1, float fParam4)//Position - 0x24ED8
{
	struct<3> Var0;
...
int func_276(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x25390
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_337(struct<6> Param0, struct<6> Param6)//Position - 0x27FC4
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_362(struct<3> Param0, bool bParam3)//Position - 0x28EB2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_385(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x29965
{
	if (bParam6)
	{
...
void func_427(int iParam0, bool bParam1, bool bParam2)//Position - 0x2B93C
{
	if (iParam0 < 9)
	{
		if (bParam2)
...
float func_442(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2C884
{
	return ((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1));
}
...
void func_477(struct<3> Param0, float fParam3, struct<3> Param4)//Position - 0x2DADE
{
...
void func_478(int iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, int iParam10)//Position - 0x2DB12
{
	iLocal_94 = iParam0;
