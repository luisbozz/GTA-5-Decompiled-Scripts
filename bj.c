...
void func_67(int iParam0, bool bParam1)//Position - 0x63C5
{
...
void func_147(bool bParam0, int iParam1)//Position - 0xC184
{
	int iVar0;
...
void func_178(bool bParam0, int iParam1)//Position - 0xE684
{
...
int func_196(int iParam0, int iParam1, bool bParam2)//Position - 0xF375
{
	int iVar0;
...
int func_197(int iParam0, bool bParam1)//Position - 0xF477
{
...
int func_204(struct<8> Param0, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)//Position - 0x14AB2
{
	char cVar0[64];
...
void func_221(int* iParam0, bool bParam1, bool bParam2)//Position - 0x15293
{
	if (bParam2)
	{
...
void func_265(struct<3> Param0, int iParam3, int iParam4, int iParam5, var uParam6, float fParam7)//Position - 0x16D94
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_269(struct<3> Param0, int* iParam3, var uParam4, var uParam5)//Position - 0x1711A
{
	float fVar0;
	int iVar1;
...
float func_275(struct<3> Param0, struct<3> Param3)//Position - 0x1754F
{
...
void func_286(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x17C51
{
	struct<60> Var0;
...
void func_310(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x1D618
{
	if (func_307(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_312(int iParam0, bool bParam1, bool bParam2)//Position - 0x1D76E
{
	if (iParam0 == -1)
	{
		return;
...
bool func_317(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x1D96F
{
	if (bParam6)
	{
...
int func_329(var uParam0, int* iParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, var uParam11, var uParam12)//Position - 0x1E383
{
	struct<3> Var0;
...
int func_332(var uParam0, var uParam1, var uParam2, int* iParam3, var uParam4, var uParam5, struct<3> Param6, struct<3> Param9)//Position - 0x1E532
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
float func_349(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x1F399
{
	return ((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1));
}
...
void func_355(struct<3> Param0, var uParam3, var uParam4, var uParam5)//Position - 0x1F54A
{
	var uVar0;
	var uVar1;
	float fVar2;
...
void func_356(struct<3> Param0, var uParam3, var uParam4)//Position - 0x1F6BA
{
	float fVar0;
	float fVar1;
	struct<3> Var2;
...
int func_357(struct<3> Param0, int iParam3, int iParam4)//Position - 0x1F7A1
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void func_381(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1FF8A
{
	float fVar0;
	int iVar1;
	int iVar2;
...
float func_430(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x21B18
{
...
Vector3 func_463(struct<3> Param0, float fParam3)//Position - 0x22F5D
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_472(bool bParam0, int iParam1)//Position - 0x233DB
{
...
void func_487(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x2396D
{
	int iVar0;
...
void func_513(var uParam0, bool bParam1, bool bParam2)//Position - 0x248CA
{
	if (bParam2)
	{
...
void func_558(bool bParam0, bool bParam1)//Position - 0x26279
{
	if (bParam1)
	{
