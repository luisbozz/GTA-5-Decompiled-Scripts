...
bool func_95(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E2B
{
...
int func_97(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2FBD
{
	bool bVar0;
	float fVar1;
...
int func_101(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, var uParam7, int iParam8, var uParam9, var uParam10, int iParam11, float fParam12)//Position - 0x3096
{
	float fVar0;
...
void func_105(int* iParam0, struct<3> Param1, bool bParam4)//Position - 0x3386
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_106(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x33A7
{
	int iVar0;
...
void func_108(int* iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x342E
{
	switch (*iParam4)
	{
		case 0:
...
void func_114(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3A5F
{
	if (func_449(iParam0))
	{
...
int func_124(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3C60
{
	switch (iParam0)
	{
		case 0:
...
int func_125(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x3F35
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_128(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x4014
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_127(iParam1, "Loading", 0))
...
int func_130(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x40DB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_131(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)//Position - 0x4156
{
	if (func_6(*iParam0))
	{
		switch (*iParam2)
...
int func_143(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x4842
{
...
void func_162(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x5A65
{
	int iVar0;
	int iVar1;
...
void func_177(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x6404
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_180(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6543
{
	if (bParam6)
	{
...
float func_191(struct<3> Param0, struct<3> Param3)//Position - 0x6C4F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_196(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x6E85
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_205(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x7447
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_254(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x8D8F
{
	int iVar0;
	int iVar1;
...
void func_270(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x9147
{
	int iVar0;
...
int func_321(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x12946
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_390(bool bParam0)//Position - 0x2770C
{
...
void func_392(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x2775B
{
	struct<60> Var0;
...
void func_429(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2D463
{
	if (func_426(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_431(int iParam0, bool bParam1, bool bParam2)//Position - 0x2D5B9
{
	if (iParam0 == -1)
	{
		return;
...
void func_453(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E1D2
{
	int iVar0;
...
void func_456(int iParam0, bool bParam1, bool bParam2)//Position - 0x2E5CA
{
	int iVar0;
...
void func_461(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2E9E3
{
	if (func_462())
	{
...
bool func_468(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x2ECC2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<16> func_473(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2EEA0
{
	struct<16> Var0;
...
struct<6> func_475(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2EF3A
{
	struct<6> Var0;
