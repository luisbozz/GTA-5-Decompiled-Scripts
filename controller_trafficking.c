...
int func_101(int iParam0, bool bParam1)//Position - 0x58A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x6C7F
{
	int iVar0;
	int iVar1;
...
bool func_108(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7442
{
	if (bParam6)
	{
...
int func_115(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x78EB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_120(struct<3> Param0, float fParam3)//Position - 0x824C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_135(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x970B
{
	struct<60> Var0;
...
void func_155(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xECEC
{
	if (func_154(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_157(int iParam0, bool bParam1, bool bParam2)//Position - 0xEE42
{
	if (iParam0 == -1)
	{
		return;
