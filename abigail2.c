...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x83D7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_191(int iParam0, bool bParam1, bool bParam2)//Position - 0x22121
{
	if (iParam0 == -1)
	{
		return;
...
void func_195(bool bParam0, bool bParam1)//Position - 0x222BD
{
	if (bParam1)
	{
...
void func_240(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x274EC
{
...
void func_241(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x27524
{
	int iVar0;
	int iVar1;
...
void func_257(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x27F10
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_260(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2804C
{
	if (bParam6)
	{
...
int func_282(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x28EC4
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_286(struct<3> Param0, struct<3> Param3)//Position - 0x29190
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_295(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x29555
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_340(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2B16D
{
	bool bVar0;
	float fVar1;
...
void func_342(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2B205
{
	int iVar0;
...
void func_345(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2B415
{
	func_346(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_346(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2B43E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_350(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2B9A4
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_351(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2BC9A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_369(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2C334
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_388(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2CFE1
{
	int iVar0;
	int iVar1;
...
void func_391(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7, struct<3> Param8, float fParam11, struct<3> Param12, float fParam15)//Position - 0x2D070
{
	int* iVar0;
...
int func_392(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2D138
{
...
int func_393(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2D194
{
	int iVar0;
...
int func_396(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2D2A0
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_458(var uParam0, int iParam1, int iParam2)//Position - 0x3621C
{
...
void func_464(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x36578
{
	if (func_466())
	{
