...
void func_117(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x993A
{
	if (func_114(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_124(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9C91
{
	if (bParam6)
	{
...
int func_131(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xA31D
{
	int iVar0;
...
int func_132(struct<3> Param0, int iParam3, int iParam4)//Position - 0xA433
{
	int iVar0;
	float fVar1;
	float fVar2;
