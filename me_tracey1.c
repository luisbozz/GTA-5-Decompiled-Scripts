...
bool func_62(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x1B41
{
...
void func_65(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x1BDB
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xB416
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_235(int iParam0, bool bParam1)//Position - 0x23A67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_240(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x24E44
{
	int iVar0;
	int iVar1;
...
bool func_242(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x25607
{
	if (bParam6)
	{
...
int func_249(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x25AB0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_254(struct<3> Param0, float fParam3)//Position - 0x2640E
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_289(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x299AE
{
	int iVar0;
...
bool func_295(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x29F98
{
...
int func_304(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2ABED
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_308(struct<3> Param0, struct<3> Param3)//Position - 0x2AEB9
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
void func_316(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2AFEE
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
	{
...
void func_317(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2B026
{
	int iVar0;
	int iVar1;
...
void func_333(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2BA1C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_363(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2D6A6
{
...
int func_379(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2E82F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_384(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2EEEF
{
	struct<98> Var0;
	int iVar98;
	int iVar99;
...
int func_393(var uParam0, int iParam1, int iParam2)//Position - 0x2FEFE
{
...
int func_396(int* iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x303B3
{
	int iVar0;
...
void func_398(int* iParam0, struct<3> Param1, float fParam4)//Position - 0x30588
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_399(struct<3> Param0, bool bParam3)//Position - 0x305B1
{
	int iVar0;
...
void func_401(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30625
{
	struct<3> Var0;
	var uVar3;
...
void func_402(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x306A0
{
	struct<60> Var0;
...
void func_423(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x35C90
{
	if (func_422(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_425(int iParam0, bool bParam1, bool bParam2)//Position - 0x35DE6
{
	if (iParam0 == -1)
	{
		return;
...
int func_430(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x35FAB
{
	int iVar0;
...
int func_431(struct<3> Param0, int iParam3, int iParam4)//Position - 0x360C1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_452(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x373A6
{
	int iVar0;
	int iVar1;
...
void func_465(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x3770B
{
	func_466();
...
void func_467(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3788B
{
	if (func_556())
	{
...
void func_468(struct<3> Param0, var uParam3, var uParam4)//Position - 0x37920
{
	struct<3> Var0[4];
	float fVar13[4];
	int iVar18;
...
int func_474(struct<3> Param0, float fParam3)//Position - 0x37EF8
{
	return func_475(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_475(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x37F12
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_480(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x38474
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_481(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x3867C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_503(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x3930C
{
	int iVar0;
...
void func_515(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x395D6
{
	int iVar0;
...
int func_516(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3976A
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
void func_559(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3DF7A
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
