...
void func_40(var uParam0, var uParam1, bool bParam2)//Position - 0x118C
{
	int iVar0;
...
void func_49(var uParam0, bool bParam1)//Position - 0x14A6
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_50(int iParam0, bool bParam1, bool bParam2)//Position - 0x1518
{
...
void func_51(int* iParam0, bool bParam1, bool bParam2)//Position - 0x1604
{
	if (bParam1 < 0 || bParam1 >= 64)
	{
		return;
