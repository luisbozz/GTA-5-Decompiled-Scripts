...
int func_77(var uParam0, int iParam1, int iParam2)//Position - 0x9691
{
...
int func_82(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x9967
{
	int iVar0;
	struct<82> Var1;
	int iVar99;
...
void func_83(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x9A2C
{
	func_84(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_84(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x9A55
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_92(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xA00A
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_93(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xA300
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_96(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xA458
{
	func_84(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

bool func_97(struct<3> Param0, int iParam3)//Position - 0xA482
{
	return func_98(Global_103950.f_2890.f_12.f_66, Param0, iParam3);
}

int func_98(int iParam0, struct<3> Param1, int iParam4)//Position - 0xA49F
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_100(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xA520
{
	int iVar0;
...
bool func_109(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xBFCF
{
	if (bParam6)
	{
