...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5CF1
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64B4
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x695D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x72BB
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_171(struct<3> Param0, bool bParam3)//Position - 0xBC24
{
	int iVar0;
...
bool func_192(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0xCFE1
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_195(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD3FD
{
	var uVar0;
...
float func_199(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD5B1
{
	struct<3> Var0;
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD5EB
{
	var uVar0;
...
int func_229(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEAD8
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_233(struct<3> Param0, struct<3> Param3)//Position - 0xEDA4
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_241(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF122
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF805
{
	func_256(iParam0);
...
int func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF8E3
{
...
int func_258(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF93F
{
	int iVar0;
...
void func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x11140
{
	func_220(iParam0);
...
void func_275(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x11167
{
	func_276(iParam0);
...
int func_296(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x15357
{
	int iVar0;
...
int func_297(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x153BC
{
	int iVar0;
	struct<7> Var1;
...
int func_298(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x15434
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
