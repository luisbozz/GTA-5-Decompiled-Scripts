...
void func_45(bool bParam0, bool bParam1)//Position - 0x1F0C
{
	if (bParam1)
	{
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x10561
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_200(var uParam0, bool bParam1)//Position - 0x2554E
{
