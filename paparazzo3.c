...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x8007
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_238(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2783B
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_242(struct<3> Param0, struct<3> Param3)//Position - 0x27B07
{
...
int func_251(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27ECC
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_267(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2883A
{
	int iVar0;
...
void func_271(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28A86
{
	func_272(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_272(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28AAF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_276(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x29015
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_277(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2930B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_310(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x2AC69
{
	bool bVar0;
	float fVar1;
...
void func_323(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2B07A
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_340(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2BB8A
{
	int iVar0;
...
int func_341(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2BD1E
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_404(var uParam0, int iParam1, int iParam2)//Position - 0x34E39
{
...
void func_410(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x351E3
{
	int iVar0;
...
bool func_416(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x36BD9
{
	if (bParam6)
	{
...
int func_417(struct<3> Param0, float fParam3)//Position - 0x36C20
{
	return func_418(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_418(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x36C3A
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_420(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x36FAF
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_421(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x371B7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_451(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x384BB
{
	func_266(iParam0);
...
int func_452(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x384E2
{
...
int func_453(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3853E
{
	int iVar0;
