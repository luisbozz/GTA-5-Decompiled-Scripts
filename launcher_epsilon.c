...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F92
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6755
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6BFE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x755C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_168(struct<3> Param0, bool bParam3)//Position - 0xBE50
{
	int iVar0;
...
int func_254(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x16C29
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
float func_343(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2D08E
{
	struct<3> Var0;
...
int func_365(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0x2DC30
{
	var uVar0;
...
int func_376(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2E11F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_380(struct<3> Param0, struct<3> Param3)//Position - 0x2E3EB
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_389(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2E7B0
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_391(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0x2E886
{
	var uVar0;
...
void func_408(int iParam0, bool bParam1, bool bParam2)//Position - 0x3294B
{
	if (iParam0 == -1)
	{
		return;
...
void func_439(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x342BD
{
	func_440(iParam0);
...
void func_441(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x3431F
{
	func_442(iParam0);
...
int func_447(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x34946
{
...
int func_448(int* iParam0, bool bParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x349A2
{
	int iVar0;
...
int func_453(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x34D02
{
	bool bVar0;
	float fVar1;
...
int func_476(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x38B74
{
	int iVar0;
...
int func_477(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x38BDA
{
	int iVar0;
	struct<7> Var1;
...
int func_478(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x38C52
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
