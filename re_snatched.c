...
void func_127(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x6527
{
	int iVar0;
	int iVar1;
...
void func_142(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x6F06
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_145(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7045
{
	if (bParam6)
	{
...
int func_214(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xB132
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
