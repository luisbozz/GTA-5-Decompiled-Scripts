...
int func_28(struct<7> Param0, struct<7> Param7, int iParam14)//Position - 0x9878
{
	int iVar0;
	int iVar1;
...
var func_39(struct<7> Param0, int iParam7)//Position - 0x9BCE
{
	var uVar0;
	var uVar1;
	var uVar2;
...
var func_49(struct<6> Param0, var uParam6)//Position - 0x9FD9
{
	var uVar0;
...
void func_62(char* sParam0, char[8] cParam1, char[4] cParam3, char[4] cParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12)//Position - 0xA656
{
