...
int func_146(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x9592
{
	int iVar0;
	int iVar1;
...
int func_154(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0xA1B7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_159(struct<3> Param0, float fParam3)//Position - 0xAB15
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_206(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8)//Position - 0xF272
{
...
void func_209(bool bParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9)//Position - 0xF3B8
{
...
int func_226(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15)//Position - 0xFA60
{
...
void func_230(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x10C87
{
	struct<3> Var0;
	var uVar3;
...
void func_231(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x10D02
{
	struct<60> Var0;
...
void func_252(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x162F2
{
	if (func_251(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_254(int iParam0, bool bParam1, bool bParam2)//Position - 0x16448
{
	if (iParam0 == -1)
	{
		return;
...
int func_259(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x1660D
{
	int iVar0;
...
int func_260(struct<3> Param0, int iParam3, int iParam4)//Position - 0x16723
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_266(bool bParam0)//Position - 0x16C2F
{
...
int func_310(var uParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x1A7E2
{
...
void func_330(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x1B730
{
	if (func_300())
	{
