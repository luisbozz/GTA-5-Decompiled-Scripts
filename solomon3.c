...
int func_64(int iParam0, bool bParam1)//Position - 0x4B67
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_69(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5F42
{
	int iVar0;
	int iVar1;
...
bool func_71(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6705
{
	if (bParam6)
	{
...
int func_78(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6BAE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_83(struct<3> Param0, float fParam3)//Position - 0x750C
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_126(bool bParam0, int iParam1)//Position - 0xBD57
{
...
int func_131(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xBEC0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_145(struct<3> Param0, float fParam3)//Position - 0xF5B9
{
	return func_146(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_146(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xF5D3
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
void func_155(int iParam0, bool bParam1, bool bParam2)//Position - 0xFF57
{
	if (iParam0 == -1)
	{
		return;
...
int func_163(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x11A1E
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_179(var uParam0, int iParam1, int iParam2)//Position - 0x12D3F
{
...
void func_194(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x130B1
{
	int iVar0;
...
void func_204(int iParam0, bool bParam1, bool bParam2)//Position - 0x13BFF
{
	int iVar0;
...
void func_206(int iParam0, bool bParam1, bool bParam2)//Position - 0x13CA1
{
	int iVar0;
...
void func_276(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, bool bParam8)//Position - 0x19E4B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_290(bool bParam0)//Position - 0x1AE7E
{
	if (bParam0 < 32)
	{
...
float func_331(struct<3> Param0, struct<3> Param3)//Position - 0x1DB33
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
void func_337(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x1DEBC
{
	bool bVar0;
	int iVar1;
...
int func_338(struct<3> Param0, struct<3> Param3, float fParam6, float fParam7)//Position - 0x1DF2F
{
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
		if (!bLocal_88)
...
int func_367(struct<3> Param0, bool bParam3)//Position - 0x21736
{
	int iVar0;
...
void func_373(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x21EC0
{
	struct<3> Var0;
	var uVar3;
...
void func_374(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x21F3B
{
	struct<60> Var0;
...
void func_376(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2217B
{
	if (func_161(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_379(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x22312
{
	int iVar0;
...
int func_380(struct<3> Param0, int iParam3, int iParam4)//Position - 0x22428
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_415(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x24C9B
{
	if (func_23())
	{
...
int func_423(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0x2622A
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
