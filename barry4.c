...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x7F3B
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_233(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x27517
{
	if (func_364())
	{
...
void func_234(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x275AC
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_251(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2801E
{
	int iVar0;
...
int func_252(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x281B2
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_317(var uParam0, int iParam1, int iParam2)//Position - 0x31475
{
...
void func_323(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x3181F
{
	int iVar0;
...
bool func_329(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x33215
{
	if (bParam6)
	{
...
int func_330(struct<3> Param0, float fParam3)//Position - 0x3325C
{
	return func_331(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_331(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x33276
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_333(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x335EB
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_334(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x337F3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
