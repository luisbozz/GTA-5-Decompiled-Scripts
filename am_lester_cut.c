...
void func_23(int iParam0, bool bParam1, bool bParam2)//Position - 0xFD6
{
	int iVar0;
...
void func_28(int iParam0, bool bParam1, bool bParam2)//Position - 0x143B
{
	int iVar0;
...
void func_92(bool bParam0)//Position - 0x3E57
{
...
void func_104(bool bParam0, bool bParam1, int iParam2)//Position - 0x40AD
{
	switch (bParam0)
	{
		case 5:
...
void func_126(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x4664
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_145(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x55E6
{
	int iVar0;
...
void func_253(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x76D8
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_238();
