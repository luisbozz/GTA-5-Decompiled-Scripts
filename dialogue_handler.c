...
float func_108(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)//Position - 0x525E
{
	struct<2> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_109(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x536D
{
