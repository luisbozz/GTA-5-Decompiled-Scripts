...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C9F
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6462
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x690B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x7269
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_171(struct<3> Param0, bool bParam3)//Position - 0xBBF2
{
	int iVar0;
...
void func_190(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)//Position - 0xCE9C
{
	switch (*uParam0)
	{
		case 0:
...
float func_203(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD5C7
{
	struct<3> Var0;
...
int func_205(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xD69E
{
	var uVar0;
...
int func_231(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xEABA
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_235(struct<3> Param0, struct<3> Param3)//Position - 0xED86
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_243(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xF104
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
bool func_255(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xF4B2
{
...
void func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFA8B
{
	func_222(iParam0);
...
void func_266(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFAB2
{
	func_267(iParam0);
...
void func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFF11
{
	func_271(iParam0);
...
int func_273(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x1016C
{
...
int func_274(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x101C8
{
	int iVar0;
...
int func_292(int iParam0, struct<3> Param1, float fParam4)//Position - 0x10F40
{
	int iVar0[4];
	int iVar5;
...
int func_293(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10FD1
{
	int iVar0;
	struct<7> Var1;
...
int func_294(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x11049
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
