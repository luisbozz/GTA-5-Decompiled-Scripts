...
void func_45(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x621F
{
	if (func_42(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_52(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6576
{
	if (bParam6)
	{
...
int func_59(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x6C02
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_102(var uParam0, int iParam1, int iParam2)//Position - 0xB982
{
...
void func_225(struct<3> Param0, float fParam3, int iParam4, float fParam5, bool bParam6)//Position - 0x29AE3
{
	int iVar0;
