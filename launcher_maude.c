...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5B5B
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x631E
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x67C7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x7125
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
float func_190(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCA0E
{
	struct<3> Var0;
...
int func_210(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDB7C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_214(struct<3> Param0, struct<3> Param3)//Position - 0xDE48
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_222(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE1C6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_235(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xE7E8
{
...
int func_236(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xE844
{
	int iVar0;
...
void func_238(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE918
{
	func_201(iParam0);
...
int func_252(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEE98
{
	int iVar0;
...
int func_253(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xEEFD
{
	int iVar0;
	struct<7> Var1;
...
int func_254(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xEF75
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
