...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5CED
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x64B0
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x6959
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x72B7
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_172(struct<3> Param0, bool bParam3)//Position - 0xBC55
{
	int iVar0;
...
int func_189(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xCEB2
{
	var uVar0;
...
float func_193(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD066
{
	struct<3> Var0;
...
int func_194(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xD0A0
{
	var uVar0;
...
int func_209(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xD93F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_225(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xE6A7
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_229(struct<3> Param0, struct<3> Param3)//Position - 0xE973
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xECF1
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_250(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF36D
{
	func_251(iParam0);
...
int func_252(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xF44B
{
...
int func_253(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xF4A7
{
	int iVar0;
...
void func_255(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF57B
{
	func_208(iParam0);
...
int func_272(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xFEA5
{
	int iVar0;
...
int func_273(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xFF0A
{
	int iVar0;
	struct<7> Var1;
...
int func_274(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xFF82
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
