...
void func_95(int iParam0, bool bParam1)//Position - 0x3BCA
{
...
void func_116(struct<3> Param0, float fParam3, float fParam4)//Position - 0x506D
{
	int iVar0;
	float fVar1;
...
void func_135(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x5DA8
{
	if (!iLocal_1138)
	{
...
void func_161(struct<25> Param0, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38)//Position - 0x7EE8
{
	float fVar0;
...
float func_268(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xD18F
{
	struct<3> Var0;
...
float func_282(struct<3> Param0, bool bParam3)//Position - 0xD816
{
...
int func_328(int iParam0, bool bParam1)//Position - 0x10C71
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_333(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x1204C
{
	int iVar0;
	int iVar1;
...
int func_341(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x12C71
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_346(struct<3> Param0, float fParam3)//Position - 0x135CF
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_388(bool bParam0, bool bParam1)//Position - 0x17093
{
	if (bParam1)
	{
...
void func_398(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x173C9
{
	func_399(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_399(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x173F3
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_401(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x17813
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_402(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x17B09
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_411(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x17F50
{
...
void func_423(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1851D
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_424(struct<3> Param0, bool bParam3)//Position - 0x18546
{
	int iVar0;
...
void func_464(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x1A5EE
{
	if (func_537())
	{
...
int func_465(struct<3> Param0, float fParam3)//Position - 0x1A683
{
	return func_466(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_466(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x1A69D
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
void func_486(int iParam0, bool bParam1, bool bParam2)//Position - 0x1E670
{
	if (iParam0 == -1)
	{
		return;
...
int func_494(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x20135
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_495(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x2033D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_510(var uParam0, int iParam1, int iParam2)//Position - 0x214B9
{
...
void func_524(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x217CB
{
	int iVar0;
