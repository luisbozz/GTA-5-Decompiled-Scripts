...
int func_67(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5C41
{
	int iVar0;
	int iVar1;
...
bool func_69(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x6404
{
	if (bParam6)
	{
...
int func_76(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x68AD
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_81(struct<3> Param0, float fParam3)//Position - 0x720B
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_186(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xC959
{
	var uVar0;
...
float func_190(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xCB0D
{
	struct<3> Var0;
...
int func_214(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xDE7F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_218(struct<3> Param0, struct<3> Param3)//Position - 0xE14B
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_226(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xE4C9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_239(int* iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xEAB0
{
...
void func_240(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEB16
{
	func_241(iParam0);
...
int func_242(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xEBF4
{
...
int func_243(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xEC50
{
	int iVar0;
...
int func_259(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xF473
{
	int iVar0;
...
int func_260(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF4D8
{
	int iVar0;
	struct<7> Var1;
...
int func_261(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0xF550
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
