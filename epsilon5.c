...
void func_232(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x282A1
{
	int iVar0;
...
void func_236(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x284ED
{
	func_237(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_237(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28517
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_241(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28A7D
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_242(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x28D73
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_284(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x29F7C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
int func_308(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2ADFE
{
...
int func_309(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2AE5A
{
	int iVar0;
