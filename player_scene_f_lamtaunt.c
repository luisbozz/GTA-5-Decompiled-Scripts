...
int func_95(struct<6> Param0, struct<6> Param6)//Position - 0x4086
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_108(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x49CC
{
	if (iParam0 == iParam5)
	{
		return;
...
int func_119(struct<3> Param0, bool bParam3)//Position - 0x4F22
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_126(struct<3> Param0, float fParam3, float fParam4)//Position - 0x56D3
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_127(struct<3> Param0, float fParam3, float fParam4)//Position - 0x574C
{
	struct<3> Var0;
	float fVar3;
...
Vector3 func_128(struct<3> Param0, float fParam3)//Position - 0x5794
{
	float fVar0;
...
bool func_131(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x580C
{
	if (bParam6)
	{
