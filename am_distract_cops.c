...
void func_104(struct<67> Param0, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, int iParam85)//Position - 0x2DCC
{
	struct<3> Var0;
	int iVar36;
...
var func_106(bool bParam0)//Position - 0x2E6D
{
	var uVar0;
...
void func_112(bool bParam0, int iParam1, int iParam2)//Position - 0x2FE3
{
	struct<8> Var0;
...
void func_138(int iParam0, bool bParam1)//Position - 0x37B4
{
...
void func_150(struct<3> Param0, int iParam3, int iParam4, char* sParam5, int iParam6)//Position - 0x3AA4
{
	int iVar0;
	int iVar1;
...
float func_153(struct<3> Param0, var uParam3, var uParam4)//Position - 0x3C00
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_227(struct<3> Param0, int iParam3, int iParam4)//Position - 0x6063
{
...
void func_228(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x608D
{
	func_229(Param0, 0f, 0f, 0f, uParam3, 0, iParam4, iParam5);
}

void func_229(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9)//Position - 0x60A7
{
	struct<12> Var0;
...
void func_230(struct<12> Param0, int iParam12)//Position - 0x611D
{
...
int func_233(struct<3> Param0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12)//Position - 0x61C8
{
	int iVar0;
...
bool func_234(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9)//Position - 0x6301
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_235(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9)//Position - 0x6345
{
...
int func_236(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7)//Position - 0x639C
{
	struct<3> Var0;
...
void func_246(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x656C
{
	func_247(Param0, 0f, 0f, 0f, fParam3, 0, iParam4, iParam6, iParam5, iParam7);
}

void func_247(struct<3> Param0, struct<3> Param3, var uParam6, int iParam7, int iParam8, var uParam9, var uParam10, var uParam11)//Position - 0x658A
{
	struct<12> Var0;
...
void func_248(struct<12> Param0, int iParam12)//Position - 0x6619
{
...
void func_277(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x700B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_269();
