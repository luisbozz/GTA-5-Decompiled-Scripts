...
void func_147(int iParam0, bool bParam1, bool bParam2)//Position - 0x685D
{
	int iVar0;
...
int func_170(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x8AF6
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_171(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x8E90
{
	if (bParam6)
	{
