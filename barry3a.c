...
bool func_210(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x26CC8
{
...
int func_216(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x26DB9
{
	int iVar0;
...
int func_295(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C4C6
{
	int iVar0;
	int iVar1;
...
bool func_297(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2CC89
{
	if (bParam6)
	{
...
int func_303(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2D127
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_308(struct<3> Param0, float fParam3)//Position - 0x2DA85
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_338(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2F530
{
	struct<3> Var0;
	var uVar3;
...
void func_339(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x2F5AB
{
	struct<60> Var0;
...
void func_358(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x34B72
{
	if (func_357(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_362(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x34DD5
{
	int iVar0;
...
int func_363(struct<3> Param0, int iParam3, int iParam4)//Position - 0x34EEB
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_379(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x358D1
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_383(struct<3> Param0, struct<3> Param3)//Position - 0x35B9D
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
void func_407(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x36443
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_445(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x37529
{
...
void func_451(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x37866
{
	if (func_453())
	{
