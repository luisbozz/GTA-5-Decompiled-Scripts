...
void func_6(bool bParam0)//Position - 0x326
{
...
void func_16(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x5F7
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_34(bool bParam0, bool bParam1, int iParam2)//Position - 0xD8F
{
	switch (bParam0)
	{
		case 5:
...
bool func_96(var uParam0, bool bParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x2E94
{
...
bool func_98(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x81B4
{
	if (bParam6)
	{
...
int func_142(var uParam0, int iParam1, int iParam2)//Position - 0xA6DA
{
...
int func_152(bool bParam0, int iParam1)//Position - 0xA99F
{
	int iVar0;
...
void func_287(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11)//Position - 0x3317F
{
