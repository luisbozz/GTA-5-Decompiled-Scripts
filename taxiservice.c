...
void func_181(bool bParam0, bool bParam1, int iParam2)//Position - 0xCFB7
{
	switch (iParam0)
	{
		case 5:
...
void func_197(struct<3> Param0, bool bParam3)//Position - 0xEB03
{
	int iVar0;
	int iVar1;
...
void func_198(struct<3> Param0, int iParam3)//Position - 0xEC22
{
	func_199(iParam3);
...
void func_200(struct<3> Param0, int iParam3)//Position - 0xECA8
{
	Local_829[iParam3 /*3*/] = { Param0 };
	if (func_127(Local_829[iParam3 /*3*/]) == HUD::GET_WAYPOINT_BLIP_ENUM_ID())
	{
...
bool func_207(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xEEC9
{
	if (bParam6)
	{
