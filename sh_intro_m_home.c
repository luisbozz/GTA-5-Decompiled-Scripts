...
void func_49(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x6DE4
{
	if (func_45(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_51(int iParam0, bool bParam1, bool bParam2)//Position - 0x6F3A
{
	if (iParam0 == -1)
	{
		return;
...
bool func_56(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x713B
{
	if (bParam6)
	{
...
void func_64(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x77F5
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x11067
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_222(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x26A8C
{
	struct<3> Var0;
...
bool func_223(var uParam0, struct<2> Param1, var uParam3)//Position - 0x26AB6
{
	bool bVar0;
	int iVar1;
	int iVar2;
