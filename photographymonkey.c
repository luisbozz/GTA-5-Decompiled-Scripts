...
void func_97(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1A919
{
...
int func_98(struct<3> Param0, float fParam3, float fParam4)//Position - 0x1A93F
{
	float fVar0;
	float fVar1;
...
void func_99(struct<3> Param0, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)//Position - 0x1A97F
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
Vector3 func_102(struct<3> Param0, struct<3> Param3)//Position - 0x1AB8D
{
...
void func_116(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7, float fParam8)//Position - 0x1B8C5
{
