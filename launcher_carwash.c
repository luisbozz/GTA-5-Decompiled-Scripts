...
float func_64(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2057
{
	struct<3> Var0;
...
void func_69(var uParam0, struct<3> Param1, float fParam4)//Position - 0x21E0
{
...
void func_71(var uParam0, int iParam1, char* sParam2, struct<3> Param3, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0x2230
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { Param3 };
	uParam0->f_4 = sParam7;
