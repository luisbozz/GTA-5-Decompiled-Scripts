...
void func_85(struct<2> Param0, Vector3 vParam2, struct<2> Param3, var uParam5, float fParam6, float fParam7, int iParam8)//Position - 0x3544
{
	if (!iLocal_318)
	{
...
int func_195(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9402
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_196(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x979C
{
	if (bParam6)
	{
