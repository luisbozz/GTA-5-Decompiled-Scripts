...
void func_21(bool bParam0, bool bParam1)//Position - 0x2A4A
{
	if (bParam1)
	{
...
int func_96(struct<3> Param0, float fParam3, float fParam4)//Position - 0xC632
{
...
float func_102(struct<2> Param0, float fParam2, struct<2> Param3, float fParam5, int iParam6)//Position - 0xCA09
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_107(int iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6, bool bParam7, int iParam8)//Position - 0xCD65
{
	int iVar0;
...
void func_109(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8, struct<3> Param11, struct<3> Param14, struct<3> Param17, struct<3> Param20, struct<3> Param23, struct<3> Param26, struct<3> Param29)//Position - 0xD632
{
	if (iLocal_52 > 0)
	{
...
void func_110(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, struct<3> Param13, struct<3> Param16, struct<3> Param19)//Position - 0xD68C
{
...
void func_113(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, struct<3> Param8)//Position - 0xDAA9
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_115(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, bool bParam12)//Position - 0xEBAF
{
...
void func_121(var uParam0, struct<2> Param1, var uParam3, struct<2> Param4, var uParam6, struct<2> Param7, var uParam9, struct<2> Param10, var uParam12)//Position - 0xF38B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_128(struct<3> Param0, bool bParam3)//Position - 0x1010B
{
	if (iLocal_438 == 0)
	{
		bParam3 = false;
...
bool func_168(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x16526
{
	if (bParam6)
	{
...
void func_191(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x18941
{
...
void func_209(var uParam0, var uParam1, char* sParam2, float fParam3, struct<3> Param4, float fParam7, int iParam8)//Position - 0x1A621
{
	int iVar0;
...
bool func_228(int* iParam0, struct<3> Param1, struct<3> Param4, bool bParam7, char* sParam8, bool bParam9, bool bParam10, int iParam11)//Position - 0x1B0AE
{
...
int func_229(int* iParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10, bool bParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, char* sParam19, char* sParam20, char* sParam21, char* sParam22, char* sParam23, char* sParam24, bool bParam25, bool bParam26, char* sParam27, bool bParam28, int iParam29, bool bParam30, int iParam31, int iParam32, int iParam33, int iParam34, bool bParam35, float fParam36)//Position - 0x1B0FF
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_236(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x1BC4A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_286(struct<3> Param0, float fParam3)//Position - 0x202AD
{
	return func_287(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_287(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x202C7
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
void func_313(int iParam0, bool bParam1, bool bParam2)//Position - 0x2491C
{
	if (iParam0 == -1)
	{
		return;
...
int func_323(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2667F
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_338(var uParam0, int iParam1, int iParam2)//Position - 0x27988
{
...
void func_353(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x27CFA
{
	int iVar0;
...
int func_360(struct<3> Param0, float fParam3)//Position - 0x27E35
{
...
int func_363(int iParam0, struct<3> Param1, int iParam4)//Position - 0x27E75
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_367(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x27F1C
{
	if (func_377())
	{
...
int func_368(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x27FB1
{
	int iVar0;
...
int func_403(int iParam0, bool bParam1)//Position - 0x2B0A4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_408(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C482
{
	int iVar0;
	int iVar1;
...
int func_415(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2D09C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_420(struct<3> Param0, float fParam3)//Position - 0x2D9FA
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
