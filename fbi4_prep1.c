...
bool func_107(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3161
{
...
int func_109(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x32D2
{
	bool bVar0;
	float fVar1;
...
int func_113(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)//Position - 0x33B5
{
	float fVar0;
...
void func_117(int* iParam0, struct<3> Param1, bool bParam4)//Position - 0x36A5
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_118(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x36C6
{
	int iVar0;
...
void func_120(int* iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x374D
{
	switch (*iParam4)
	{
		case 0:
...
void func_124(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3BA6
{
	if (func_343(iParam0))
	{
...
void func_128(struct<3> Param0, struct<3> Param3)//Position - 0x3D0D
{
	Local_82.f_8 = { Param0 };
...
float func_133(struct<3> Param0, struct<3> Param3)//Position - 0x4075
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_149(int iParam0, struct<3> Param1, float fParam4)//Position - 0x456F
{
	switch (iParam0)
	{
		case 0:
...
int func_150(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x4835
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_153(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x4913
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_152(iParam1, "Loading", 0))
...
int func_154(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x49C6
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_159(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x5556
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_165(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, int iParam6)//Position - 0x597C
{
	float fVar0;
	float fVar1;
	float fVar2;
...
float func_170(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x5AF3
{
...
int func_178(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x5DFC
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_191(struct<3> Param0, int iParam3, struct<3> Param4)//Position - 0x6A3B
{
	Local_82.f_2 = { Param0 };
	Local_82.f_8 = { Param4 };
...
int func_200(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x6FFA
{
...
void func_215(int* iParam0, int iParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)//Position - 0x7B7C
{
	if (func_37(*iParam0))
	{
		switch (*iParam2)
...
int func_225(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x81FE
{
...
float func_235(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x893F
{
	struct<3> Var0;
...
void func_243(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x8C96
{
	func_244(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_244(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x8CB4
{
...
void func_245(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x8CEC
{
	int iVar0;
	int iVar1;
...
void func_260(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x968B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_272(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x9DC1
{
	int iVar0;
	int iVar1;
...
void func_283(bool bParam0)//Position - 0xA119
{
...
void func_285(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0xA168
{
	struct<60> Var0;
...
void func_322(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xFE40
{
	if (func_319(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_324(int iParam0, bool bParam1, bool bParam2)//Position - 0xFF96
{
	if (iParam0 == -1)
	{
		return;
...
void func_347(int iParam0, bool bParam1, bool bParam2)//Position - 0x10BE7
{
	int iVar0;
...
void func_353(int iParam0, bool bParam1, bool bParam2)//Position - 0x11080
{
	int iVar0;
...
void func_358(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x11499
{
	if (func_359())
	{
...
void func_364(var uParam0, struct<3> Param1, int iParam4, float fParam5, float fParam6, float fParam7, int iParam8, struct<3> Param9, struct<3> Param12)//Position - 0x11E1A
{
	uParam0->f_3 = { Param1 };
	uParam0->f_6 = fParam5;
	uParam0->f_7 = fParam6;
...
struct<25> func_365(struct<3> Param0, struct<3> Param3, float fParam6, int iParam7)//Position - 0x11E5E
{
	struct<25> Var0;
...
bool func_369(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x12086
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<14> func_374(struct<3> Param0, float fParam3, int iParam4)//Position - 0x12288
{
	struct<14> Var0;
...
struct<6> func_376(struct<3> Param0, float fParam3, int iParam4)//Position - 0x122D5
{
	struct<6> Var0;
