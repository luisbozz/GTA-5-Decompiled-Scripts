...
void func_6(bool bParam0)//Position - 0x324
{
...
void func_16(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x5F5
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
void func_34(bool bParam0, bool bParam1, int iParam2)//Position - 0xD8D
{
	switch (bParam0)
	{
		case 5:
...
bool func_96(var uParam0, bool bParam1, int iParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, int iParam13, int iParam14)//Position - 0x2E92
{
...
bool func_98(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x81B3
{
	if (bParam6)
	{
...
int func_142(var uParam0, int iParam1, int iParam2)//Position - 0xA6D9
{
...
int func_152(bool bParam0, int iParam1)//Position - 0xA99E
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x17ADE
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_275(bool bParam0, int iParam1)//Position - 0x32FAF
{
...
void func_287(var uParam0, struct<3> Param1, struct<3> Param4, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3317C
{
