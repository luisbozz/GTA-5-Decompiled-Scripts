...
void func_16(struct<3> Param0, bool bParam3)//Position - 0x958
{
	if (iLocal_223 == 0)
	{
		bParam3 = false;
...
void func_57(int iParam0, bool bParam1)//Position - 0x28D9
{
	if (iParam0 == -1)
	{
		iParam0 = func_74();
...
int func_64(int iParam0, bool bParam1)//Position - 0x3009
{
	switch (iParam0)
	{
		case 0:
...
void func_72(int iParam0, bool bParam1)//Position - 0x377F
{
...
int func_138(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x75AE
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_139(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7948
{
	if (bParam6)
	{
