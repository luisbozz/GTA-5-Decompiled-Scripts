...
float func_46(struct<3> Param0, struct<3> Param3, struct<3> Param6, struct<3> Param9, float fParam12, bool bParam13)//Position - 0x2D87
{
	struct<2> Var0;
	float fVar3;
	float fVar4;
...
Vector3 func_47(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2E96
{
...
int func_55(struct<6> Param0, struct<6> Param6)//Position - 0x3659
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
