...
float func_23(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x1C87
{
	struct<3> Var0;
...
void func_43(struct<3> Param0, float fParam3, float fParam4)//Position - 0x230E
{
	bool bVar0;
	struct<3> Var1;
	float fVar4;
...
void func_78(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3454
{
	func_79(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_79(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x3472
{
...
void func_80(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x34AA
{
	int iVar0;
	int iVar1;
...
void func_95(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x3E49
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_98(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x3F88
{
	if (bParam6)
	{
...
int func_144(struct<9> Param0, var uParam9)//Position - 0x6410
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_148(struct<4> Param0, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, struct<4> Param10, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19)//Position - 0x6494
{
	int iVar0;
	int iVar1;
...
int func_194(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x998F
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
