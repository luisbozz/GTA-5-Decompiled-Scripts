...
void func_59(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x5037
{
	int iVar0;
...
void func_179(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x23098
{
	func_180(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_180(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x230C1
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_184(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x23628
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_185(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2391E
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_220(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x25D57
{
	float fVar0;
	int iVar1;
	int iVar2;
