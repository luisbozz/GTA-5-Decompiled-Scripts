...
void func_52(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x1E21
{
	int iVar0;
...
void func_171(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x20032
{
	func_172(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_172(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2005B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_176(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x205C1
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_177(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x208B7
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_180(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x20A0F
{
...
int func_208(struct<3> Param0, float fParam3)//Position - 0x258C8
{
	struct<3> Var0;
...
int func_210(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2590B
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_213(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x25A2D
{
	int iVar0;
	int iVar1;
...
int func_225(int iParam0, struct<3> Param1, float fParam4)//Position - 0x25D59
{
	switch (iParam0)
	{
		case 0:
...
int func_226(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x26183
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_212(iParam1, "Loading", 0))
...
int func_228(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x262A8
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_238(int* iParam0, struct<3> Param1, bool bParam4)//Position - 0x265AC
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_239(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x265CD
{
	int iVar0;
...
bool func_242(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x26769
{
...
bool func_244(var uParam0, struct<2> Param1, float fParam3)//Position - 0x2683B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_298(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2AC42
{
	int iVar0;
	int iVar1;
...
bool func_300(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2B405
{
	if (bParam6)
	{
...
int func_307(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x2B8AE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_312(struct<3> Param0, float fParam3)//Position - 0x2C20D
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
void func_353(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2FB62
{
...
void func_354(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2FB9A
{
	int iVar0;
	int iVar1;
...
void func_369(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x3053B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_412(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x31FD3
{
	struct<3> Var0;
	var uVar3;
...
void func_413(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3204E
{
	struct<60> Var0;
...
void func_434(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x37640
{
	if (func_433(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_441(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x3795B
{
	int iVar0;
...
int func_442(struct<3> Param0, int iParam3, int iParam4)//Position - 0x37A71
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_461(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x37F66
{
	if (func_463())
	{
...
struct<7> func_479(struct<3> Param0, float fParam3, int iParam4)//Position - 0x3864E
{
	struct<7> Var0;
...
struct<6> func_481(struct<3> Param0, float fParam3, int iParam4)//Position - 0x386BB
{
	struct<6> Var0;
