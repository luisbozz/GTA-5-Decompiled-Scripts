...
void func_67(int iParam0, bool bParam1, bool bParam2)//Position - 0x66D1
{
	if (iParam0 == -1)
	{
		return;
...
int func_77(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x8435
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_78(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x863D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_94(var uParam0, int iParam1, int iParam2)//Position - 0x97CF
{
...
void func_109(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x9B41
{
	int iVar0;
...
void func_121(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0xA1AB
{
	func_122(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_122(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0xA1D4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_124(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xA5F4
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_125(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0xA8EA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_138(struct<3> Param0, bool bParam3)//Position - 0xB023
{
	int iVar0;
...
int func_184(int iParam0, bool bParam1)//Position - 0xE101
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_189(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0xF4DC
{
	int iVar0;
	int iVar1;
...
int func_197(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x10102
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_202(struct<3> Param0, float fParam3)//Position - 0x10A60
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_247(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0x15830
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
...
void func_249(bool bParam0)//Position - 0x16AEA
{
	MISC::CLEAR_BIT(&Global_96296, iParam0);
}

void func_250(bool bParam0)//Position - 0x16AFC
{
...
void func_256(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x16C17
{
	struct<3> Var0;
	var uVar3;
...
void func_257(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x16C92
{
	struct<60> Var0;
...
void func_259(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x16ED2
{
	if (func_73(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
int func_262(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x17069
{
	int iVar0;
...
int func_263(struct<3> Param0, int iParam3, int iParam4)//Position - 0x1717F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_268(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x17518
{
	if (func_283())
	{
