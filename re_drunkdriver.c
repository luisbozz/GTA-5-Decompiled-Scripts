...
void func_135(struct<3> Param0, int iParam3)//Position - 0x7E4B
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_136(struct<3> Param0, int iParam3)//Position - 0x802F
{
	struct<3> Var0;
...
int func_142(struct<3> Param0, bool bParam3)//Position - 0x8868
{
	int iVar0;
...
void func_175(int iParam0, bool bParam1, bool bParam2)//Position - 0x9CA1
{
	int iVar0;
...
int func_198(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xC0C2
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_199(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xC45C
{
	if (bParam6)
	{
