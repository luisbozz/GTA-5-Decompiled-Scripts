...
int func_30(struct<6> Param0, struct<6> Param6)//Position - 0x1893
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x8A98
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
