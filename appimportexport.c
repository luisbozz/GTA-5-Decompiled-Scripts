...
var func_40(bool bParam0)//Position - 0x145B
{
	var uVar0;
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x48B3
{
	switch (iParam0)
	{
		case 148:
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x678C
{
	switch (iParam0)
	{
		case 148:
...
void func_363(bool bParam0, int iParam1)//Position - 0x17114
{
