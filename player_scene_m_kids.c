...
int func_172(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x25964
{
	int iVar0;
...
bool func_184(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x27CA6
{
	if (bParam6)
	{
