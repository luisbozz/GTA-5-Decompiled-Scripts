...
int func_49(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x1B0F
{
	bool bVar0;
	float fVar1;
...
int func_58(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)//Position - 0x1E15
{
	float fVar0;
...
bool func_63(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2115
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

void func_64(int* iParam0, struct<3> Param1, bool bParam4)//Position - 0x2133
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_65(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2154
{
	int iVar0;
...
void func_70(int* iParam0, struct<3> Param1, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x221E
{
	switch (*iParam4)
	{
		case 0:
...
void func_74(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2689
{
	if (func_380(iParam0))
	{
...
int func_82(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2930
{
	int iVar0;
	int iVar1;
	char cVar2[16];
...
int func_83(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2C9E
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_86(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x2D55
{
...
int func_88(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2EAE
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (func_85(iParam1, "Loading", 0))
...
int func_90(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x2F75
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_91(int* iParam0, var uParam1, int iParam2, int* iParam3, int* iParam4, struct<3> Param5, int iParam8, bool bParam9, float fParam10)//Position - 0x2FF0
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
...
int func_101(int iParam0, struct<3> Param1, int* iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, float fParam11)//Position - 0x3659
{
...
int func_158(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x5573
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_162(struct<3> Param0, struct<3> Param3)//Position - 0x583F
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_171(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x5C04
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_211(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7E1C
{
	int iVar0;
	int iVar1;
...
void func_223(bool bParam0)//Position - 0x81CD
{
...
void func_225(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x821C
{
	struct<60> Var0;
...
void func_262(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xDEF6
{
	if (func_259(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_264(int iParam0, bool bParam1, bool bParam2)//Position - 0xE04C
{
	if (iParam0 == -1)
	{
		return;
...
int func_305(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x1527F
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_381(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A205
{
	if (func_382())
	{
...
struct<7> func_386(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2A445
{
	struct<7> Var0;
...
struct<22> func_395(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2A928
{
	struct<22> Var0;
...
struct<6> func_397(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2A9ED
{
	struct<6> Var0;
