...
int func_233(struct<8> Param0, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)//Position - 0x15270
{
	char cVar0[64];
...
void func_307(var uParam0, struct<4> Param1, var uParam5, var uParam6)//Position - 0x18EDC
{
	struct<3> Var0;
...
void func_322(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11, int iParam12, int iParam13, float fParam14, bool bParam15)//Position - 0x19ABA
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_337(int* iParam0, bool bParam1, bool bParam2)//Position - 0x1A34C
{
	if (bParam2)
	{
...
void func_415(struct<3> Param0, float fParam3, struct<3> Param4, struct<3> Param7, int iParam10)//Position - 0x20562
{
...
void func_421(struct<3> Param0, float fParam3, struct<3> Param4, struct<3> Param7, int iParam10, bool bParam11)//Position - 0x20855
{
...
void func_445(float fParam0, struct<4> Param1, var uParam5, var uParam6, var* uParam7, var uParam8)//Position - 0x20DDD
{
	int iVar0;
	int iVar1;
...
void func_461(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x21725
{
	int iVar0;
	int iVar1;
...
void func_466(struct<3> Param0, float fParam3)//Position - 0x2198E
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
void func_469(bool bParam0, bool bParam1)//Position - 0x21CBB
{
	if (bParam1)
	{
...
Vector3 func_485(bool bParam0, struct<3> Param1, struct<3> Param4)//Position - 0x22A04
{
	if (bParam0)
	{
		return Param1;
