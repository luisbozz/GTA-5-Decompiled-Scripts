...
int func_35(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x1421
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
int func_36(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x14D4
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
