...
bool func_5(bool bParam0, int iParam1)//Position - 0x711
{
	bool bVar0;
...
void func_8(bool bParam0)//Position - 0x7A9
{
...
void func_38(int iParam0, bool bParam1, bool bParam2)//Position - 0x2513
{
	int iVar0;
...
void func_41(int iParam0, bool bParam1, bool bParam2)//Position - 0x290B
{
	int iVar0;
...
bool func_94(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x4260
{
	if (bParam6)
	{
...
int func_109(bool bParam0)//Position - 0x4A93
{
	var uVar0;
...
void func_118(int iParam0, bool bParam1)//Position - 0x4E27
{
...
void func_159(int iParam0, bool bParam1, bool bParam2, char* sParam3, char* sParam4, var uParam5, int iParam6, int iParam7, int iParam8, var uParam9, var uParam10)//Position - 0x5BFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_202(struct<6> Param0, struct<6> Param6)//Position - 0x74E0
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
int func_232(struct<6> Param0, struct<6> Param6)//Position - 0x85B6
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_320(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)//Position - 0x9EF5
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_306();
