...
void func_9(bool bParam0, bool bParam1)//Position - 0x4BF
{
	if (bParam1)
	{
...
void func_176(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xBABE
{
	if (func_172(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_178(int iParam0, bool bParam1, bool bParam2)//Position - 0xBC14
{
	if (iParam0 == -1)
	{
		return;
...
int func_189(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0xC45C
{
	int iVar0;
...
int func_190(struct<3> Param0, int iParam3, int iParam4)//Position - 0xC572
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_213(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xD282
{
	struct<67> Var0;
...
int func_214(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0xD38D
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_255(var uParam0, int iParam1, int iParam2)//Position - 0x120A3
{
...
int func_291(var uParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x138EB
{
...
void func_302(bool bParam0)//Position - 0x14687
{
...
void func_305(struct<3> Param0, var uParam3, int iParam4, int iParam5)//Position - 0x1474C
{
	if (func_212())
	{
...
{
	func_314(&(Local_1109[0 /*8*/]), 85336/*func_315*/, "Van Driver Manager");
	func_314(&(Local_1109[1 /*8*/]), 83983/*func_307*/, "Cargo Manager");
}
...
float func_318(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x15B1A
{
	struct<3> Var0;
...
float func_319(struct<3> Param0, struct<3> Param3)//Position - 0x15B54
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
