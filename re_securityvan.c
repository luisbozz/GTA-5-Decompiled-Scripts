...
int func_55(int iParam0, bool bParam1)//Position - 0x360C
{
	switch (iParam0)
	{
		case 0:
...
void func_63(int iParam0, bool bParam1)//Position - 0x3D84
{
...
void func_136(bool bParam0)//Position - 0x7E44
{
...
float func_160(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x9C11
{
	struct<3> Var0;
...
int func_191(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0xC188
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
