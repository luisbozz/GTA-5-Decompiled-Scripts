...
int func_170(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x9C2D
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
...
bool func_171(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x9FC7
{
	if (bParam6)
	{
