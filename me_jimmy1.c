...
int func_31(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x1019
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_35(struct<3> Param0, struct<3> Param3)//Position - 0x12E5
{
...
bool func_82(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3173
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_89(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x3456
{
	int iVar0;
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xCC57
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_213(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x21D41
{
	func_214(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_214(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x21D6B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_218(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x222D1
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_219(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x225C7
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_282(int iParam0, bool bParam1)//Position - 0x26979
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_287(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x27D54
{
	int iVar0;
	int iVar1;
...
bool func_289(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2851C
{
	if (bParam6)
	{
...
int func_296(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7)//Position - 0x289C5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_301(struct<3> Param0, float fParam3)//Position - 0x29323
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_336(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2C7DE
{
	int iVar0;
...
void func_356(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2D7E3
{
	int iVar0;
	int iVar1;
...
void func_371(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2E1C2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_389(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2EED0
{
...
int func_396(int* iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2F4C9
{
	int iVar0;
...
void func_400(int* iParam0, struct<3> Param1, float fParam4)//Position - 0x2F5A2
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
void func_402(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2F94A
{
	int iVar0;
	int iVar1;
...
int func_425(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x302C7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_439(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x339C9
{
	int iVar0;
...
int func_440(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x33B5D
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_488(var uParam0, int iParam1, int iParam2)//Position - 0x38EEF
{
...
void func_492(struct<3> Param0, float fParam3, bool bParam4)//Position - 0x38FFB
{
	int iVar0;
...
void func_495(int iParam0, bool bParam1, bool bParam2)//Position - 0x39217
{
	if (iParam0 == -1)
	{
		return;
...
int func_501(struct<3> Param0, float fParam3)//Position - 0x3AAA9
{
	return func_502(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_502(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3AAC3
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_504(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3AE38
{
	int iVar0;
	var uVar1[3];
	int iVar5;
