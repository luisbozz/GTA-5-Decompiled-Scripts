...
void func_84(int* iParam0, struct<3> Param1, bool bParam4, bool bParam5, char* sParam6)//Position - 0x2D14
{
	if (!HUD::DOES_BLIP_EXIST(*iParam0))
	{
...
int func_85(struct<3> Param0, int iParam3, bool bParam4)//Position - 0x2D43
{
	int iVar0;
...
bool func_93(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x31F7
{
...
void func_95(int iParam0, struct<3> Param1, float fParam4)//Position - 0x32C0
{
	if (func_246(iParam0))
	{
...
int func_96(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x32E6
{
	bool bVar0;
	float fVar1;
...
int func_97(int iParam0, struct<3> Param1, float fParam4)//Position - 0x3342
{
	switch (iParam0)
	{
		case 0:
...
int func_98(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x33AA
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_114(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x391A
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3AAE
{
	int iVar0;
	var uVar1;
	struct<97> Var5;
...
int func_183(var uParam0, int iParam1, int iParam2)//Position - 0xCCB1
{
...
void func_189(struct<3> Param0, float fParam3, bool bParam4)//Position - 0xD05B
{
	int iVar0;
...
void func_192(int iParam0, bool bParam1, bool bParam2)//Position - 0xD277
{
	if (iParam0 == -1)
	{
		return;
...
bool func_198(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0xEB09
{
	if (bParam6)
	{
...
int func_199(struct<3> Param0, float fParam3)//Position - 0xEB50
{
	return func_200(&(Global_106934.f_2890), Param0, fParam3, 0);
}

int func_200(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0xEB6A
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_202(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xEEDF
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
void func_232(bool bParam0)//Position - 0xFEB1
{
...
void func_280(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x11749
{
	if (func_281())
	{
...
int func_284(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x11BE8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
bool func_355(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x28F62
{
	bool bVar0;
	int iVar1;
	int iVar2;
