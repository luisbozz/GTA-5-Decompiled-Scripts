...
void func_234(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x27486
{
	int iVar0;
...
void func_236(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x27657
{
	struct<3> Var0;
	var uVar3;
...
void func_237(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x276D2
{
	struct<60> Var0;
...
void func_271(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x2D365
{
	if (func_268(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
bool func_275(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x2D604
{
	if (bParam6)
	{
...
int func_281(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2DBE0
{
	int iVar0;
...
int func_282(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2DCF6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_285(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2DDB6
{
	func_286(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_286(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2DDDF
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_288(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2E1FF
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_289(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2E4F5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_315(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2ED91
{
	float fVar0;
	int iVar1;
	int iVar2;
