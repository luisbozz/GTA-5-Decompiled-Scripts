...
void func_151(int iParam0, int iParam1, bool bParam2)//Position - 0x4CB1
{
	int iVar0;
...
void func_155(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x4E11
{
	int iVar0;
	int iVar1;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0xF243
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_256(bool bParam0, bool bParam1, int iParam2)//Position - 0x27463
{
	switch (bParam0)
	{
		case 5:
...
float func_339(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2B730
{
...
Vector3 func_389(struct<3> Param0, struct<3> Param3)//Position - 0x2C436
{
	if (func_390())
	{
		return Param3;
...
int func_393(int iParam0, struct<3> Param1, bool bParam4, bool bParam5)//Position - 0x2C4D6
{
	if (bParam4)
	{
...
int func_396(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7)//Position - 0x2C60E
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_398(struct<3> Param0, float fParam3, float fParam4)//Position - 0x2C8EA
{
	float fVar0;
...
int func_399(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)//Position - 0x2C930
{
...
void func_405(int* iParam0, bool bParam1, bool bParam2)//Position - 0x2CA2A
{
	func_406(iParam0, bParam1, bParam2);
}

void func_406(int* iParam0, bool bParam1, bool bParam2)//Position - 0x2CA3C
{
	if (bParam2)
	{
...
int func_477(var uParam0, bool bParam1)//Position - 0x319FA
{
	int iVar0;
...
int func_485(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)//Position - 0x31F2D
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_657(bool bParam0, int iParam1)//Position - 0x34A37
{
...
Vector3 func_690(struct<3> Param0, float fParam3)//Position - 0x36CDE
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
