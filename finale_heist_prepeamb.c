...
void func_58(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x669F
{
	if (func_54(&(Global_77137.f_555[0 /*21*/]), iParam0))
	{
...
void func_60(int iParam0, bool bParam1, bool bParam2)//Position - 0x67F5
{
	if (iParam0 == -1)
	{
		return;
...
bool func_78(int iParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x71E7
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5), Param1) <= (fParam4 * fParam4);
}

bool func_79(struct<3> Param0, struct<3> Param3, bool bParam6)//Position - 0x7205
{
	if (bParam6)
	{
...
int func_147(struct<3> Param0, bool bParam3)//Position - 0x8AB0
{
	int iVar0;
...
struct<8> func_248(char* sParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0xE93F
{
	struct<8> Var0;
