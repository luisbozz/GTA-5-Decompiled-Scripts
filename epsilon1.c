...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)//Position - 0x8483
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
void func_195(int iParam0, bool bParam1, bool bParam2)//Position - 0x221CC
{
	if (iParam0 == -1)
	{
		return;
...
void func_199(bool bParam0, bool bParam1)//Position - 0x22368
{
	if (bParam1)
	{
...
int func_245(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x27A2B
{
	bool bVar0;
	float fVar1;
...
void func_271(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x283DC
{
	int iVar0;
...
void func_274(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x285EC
{
	func_275(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_275(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28615
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_279(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28B7B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_280(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x28E71
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_303(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2A91B
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_321(int* iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2B4AF
{
	func_322(iParam0);
